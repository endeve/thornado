...
\begin{table}
  ...
  \begin{tabular}{ccccccccc}
    ...
    \midrule \midrule
    8     & $x.xxx\times10^{-x}$ & ---  & $x.xxx\times10^{-x}$ & ---  & $x.xxx\times10^{-x}$ & ---  & $x.xxx\times10^{-x}$  & --- \\
    16   & $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx \\
    32   & $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx \\
    64   & $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx \\
    128 & $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx \\
    256 & $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx& $x.xxx\times10^{-x}$ &x.xx \\
    \midrule \midrule
  \end{tabular}
  \end{center}
\end{table}

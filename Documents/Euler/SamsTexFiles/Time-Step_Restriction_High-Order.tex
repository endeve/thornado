...
\blue{NOTE:} We see the effect of the high-order approximation in the presence of the quadrature end-point weight $w_{GL}$. As the order increases, $w$ decreases, thus making a tighter restriction on the time-step.

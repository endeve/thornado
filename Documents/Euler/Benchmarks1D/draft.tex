...
\begin{figure}[h]
  ...
  \end{center}
  \caption{Results showing the density for the Woodward-Collela blast wave problem at $t=0.038$, computed with 400 cells with methods of different orders: 1st (solid red), 2nd (dashed green) and 3rd (dotted blue). The solution labelled ``exact' and given by the dash-dotted pink line is the results of the problem when computed using the third-order integration method with 2000 cells.}
...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=.95\textwidth]{vel_T12_400.png}	
  \end{center}
...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=.95\textwidth]{vel_T12_2000.png}	
  \end{center}
...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=.95\textwidth]{prs_T12_400.png}	
  \end{center}
...
\begin{figure}[h]
  \begin{center}
     \includegraphics[width=.95\textwidth]{prs_T12_2000.png}	
  \end{center}

...
\author{Eirik Endeve$^{1,2,6}$, Jesse Buffaloe$^{2}$, Samuel Dunham$^{3}$, Nick Roberts$^{2}$, Kristopher Andrew$^{4,1}$, Brandon Barker$^{2}$, David Pochik$^{2}$, Juliana Pulsinelli$^{5,7}$ and Anthony Mezzacappa$^{2,6}$}
...
\address{$^{5}$Department of Astrophysical Sciences, Princeton University, NJ 08544}
...
\begin{abstract}
The toolkit for high-order neutrino-radiation hydrodynamics (\thornado) is being developed for simulations of core-collapse supernovae (CCSNe) and related problems.  
...
Essentially, the stellar interior is modeled as a perfect fluid (i.e., thermal conduction and viscosity are not explicitly included) using the Euler equations, but extended to accommodate a nuclear equation of state.  
...
The toolkit for high-order neutrino-radiation hydrodynamics (\thornado) is being developed to simulate neutrino-radiation hydrodynamics in CCSNe and related applications in nuclear astrophysics.  
...
This hydrodynamic instability is of significant astrophysical relevance --- including in the explosion phase of CCSNe --- and may occur in the interface separating fluids in relative motion.  
...
In \cite{yahilLattimer_1982,yahil_1983}, self-similar solutions to the gravitational collapse problem where constructed for $6/5\le\Gamma<4/3$.   
...
We show results for a model with $\Gamma=1.3$.  
...
The agreement of the mass density and velocity profiles is good throughout collapse.  
...
For Riemann problem~1, we observe some oscillations in the density between the leftmost shock and the contact discontinuity located near $x^{1}=0.6$.  
...
We have presented preliminary algorithm details and numerical results for solvers of the non-relativistic and special relativistic Euler equations of gas dynamics as implemented in the toolkit for high-order neutrino-radiation hydrodynamics (\thornado).  
...
Two tests in spherical symmetry (standing accretion shock \cite{blondin_etal_2003} and Yahil-Lattimer collapse \cite{yahilLattimer_1982,yahil_1983}) demonstrate the DG method's ability to handle conditions relevant to simulations of CCSN.  
...
\ack E.~E. and A.~M. acknowledge support from the NSF Gravitational Physics Program (NSF-GP 1505933 and 1806692).
...
\begin{thebibliography}{34}
  ...
  \bibitem{brennerScott_2008} Brenner, S.C. \& Scott, L.R. 2008, {\it The Mathematical Theory of Finite Element Methods}, Springer
  ...
  \bibitem{dumbser_etal_2014} Dumbser, M., Zanotti, O., Loub{\`e}re, R., \& Diot, S. 2014, {\it JCP}, {\bf 278}, 47
  \bibitem{fambri_etal_2018} Fambri, F., Dumbser, M., K{\"o}ppel, S., Rezzolla, L., \& Zanotti, O. 2018, {\it MNRAS}, {\bf 477}, 4543
  ...
  \bibitem{klockner_etal_2009} Kl{\"o}ckner, A. Warburton, T., Bridge, J. \& Hesthaven, J.S. 2009, {\it JCP}, {\bf 228}, 7863
  ...
  \bibitem{radiceRezzolla_2011} Radice, D. \& Rezzolla, L. 2011, {\it Phys. Rev. D}, {\bf 84}, 024010
  \bibitem{remacle_etal_2003} Remacle, J.-F., Flaherty, J.E., \& Shephard, M.S. 2003, {\it SIAM~Review}, {\bf 45}, 53
  \bibitem{schaal_etal_2015} Schaal, K., Bauer, A., Chandrashekar, P. R{\"u}diger, P., Klingenberg, C., \& Springel, V. 2015, {\it MNRAS}, {\bf 453}, 4278
  ...
  \bibitem{wilson_etal_1996} Wilson, J.R., Mathews, G.J., \& Marronetti, P. 1996, {\it Phys. Rev. D}, {\bf 54}, 1317

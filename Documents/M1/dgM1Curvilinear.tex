...
\begin{figure}
  \begin{center}
    \begin{tabular}{cc}
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-4_Density} &
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-6_Density} \\
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-4_FluxFactor} &
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-6_FluxFactor} \\
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-4_EddingtonFactor} &
      \includegraphics[scale=0.32]{./Figures/HomogeneousSphere1D_Chi_1e-6_EddingtonFactor}
    \end{tabular}
  \end{center}

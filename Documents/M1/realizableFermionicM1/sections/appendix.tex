...
\begin{align}
\tilde{a}_{31} + \tilde{a}_{32} = 1, \quad \tilde{a}_{32}\cdot \tilde{a}_{21} =  \frac{1}{2}.
\end{align}
An implicit property, the first-order in general transport condition, requires
\begin{align}
 \quad a_{31} + a_{32} + a_{33} = 1.
...
\end{align}
Substituting Eq.~\eqref{eq:1stOrderGeneral} into Eq.~\eqref{eq:diffusionAccurate} gives
\begin{align}

...
This scheme allows for has a larger $c_{sch}$ than IMEX PA2 (i.e., a larger time step for positivity).  
The scheme chosen by random sampling of the parameter space, and was the scheme with the largest $c_{sch}$ that satisfied both the order conditions for second order accuracy and possessed the positivity-preserving property.  

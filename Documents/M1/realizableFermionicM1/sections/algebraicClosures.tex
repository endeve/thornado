...
The Kershaw closure assumes that the convex combination has a constant coefficient which is independent from $(\cJ, \vect{\cH})$.
Therefore, using the lower occupancy limit, one can determine the coefficient and apply the convex combination as an approximation.

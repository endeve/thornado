...
For the two-moment model, the ME closure constructs the least biased distribution function based on the limited information available \cite{cernohorskyBludman_1994} --- namely $\cJ$ and $\vect{\cH}$.  

...
Two types of IMEX schemes are considered: \emph{type~A} (\ee{Insert reference to the origin of Type~A schemes}) and \emph{type~ARS} \cite{ascher_etal_1997}.  
...
%      \right.
%\end{align*}
%and the rest coefficients were defined as in \cite{hu_etal_2018}.

...
%  \end{equation}  
%  Since $f(\omega)\in[0,1]$, we have $\mathfrak{f}(\mu)\in[0,1]$, which implies $\cJ\in[0,1]$.  
%  Next we need to show that $|\vect{\cH}|\le(1-\cJ)\,\cJ$.  
%  Let $\widehat{\vect{n}}\in\bbR^{3}$ (independent of $\omega$) be an arbitrary unit vector, and write
%  \begin{equation}

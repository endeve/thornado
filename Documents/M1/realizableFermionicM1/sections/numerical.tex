...
(We also plot a reference transport solution obtained using the filtered spherical harmonics scheme described in \cite{garrettHauck_2013}; dashed black lines.)  
...
We use the IMEX scheme PD-ARS --- the least compute-intensive of the realizability-preserving IMEX schemes presented here --- in all the tests.  

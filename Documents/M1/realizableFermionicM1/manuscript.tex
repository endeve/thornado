...
The IMEX scheme is formally only first-order accurate, but works well in the diffusion limit, and --- without interactions with the background --- reduces to the optimal second-order explicit strong stability-preserving Runge-Kutta scheme of Shu \& Osher \cite{shuOsher_1988}.  

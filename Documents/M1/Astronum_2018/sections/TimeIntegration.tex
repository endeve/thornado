...
\ee{Discuss GSA and Type~ARS here.}
...
\ee{Move definition of coefficients $c_{ij}$ and $\tilde{c}_{ij}$ here.}
\ee{Discuss non-existence of high-order convex invariant scheme without explicit time step.}
...
\ee{Discuss conditions on IMEX coefficients for diffusion accuracy here.}
...
\ee{Maybe make a separate subsection combining results from previous sections here.}
\ee{Need to motivate resorting to first-order accuracy.}

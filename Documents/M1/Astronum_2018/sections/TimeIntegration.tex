...
It can be rewritten as $c=\tilde{c}$.
...
Combining the conditions we have, the 1st-order in general, high-order in streaming limit, diffusion accurate, convex-invariant IMEX schemes we need are type~ARS IMEX schemes satisfying the following constraints:
\begin{enumerate}

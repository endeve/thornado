...
This is not suprising as this is the only closure based on Fermi-Dirac statistics.  
Althought the Levermore and Minerbo closures do not satisfy the bounds in Eq.~\eqref{eq:eddingtonFactorBounds}, they are widely in simulations of neutrino transport in CCSNe \ee{and neutron star mergers?}; e.g., O'Connor \& Couch~\cite{oConnorCouch_2018}, Pan et al.~\cite{pan_etal_2018}, Glas et al.~\cite{glas_etal_2018}, and Just et al.~\cite{just_etal_2018} use the Minerbo closure, while Vartanyan et al.~\cite{vartanyan_etal_2018}, Cabezon et al.~\cite{cabezon_etal_2018}, and Kuroda et al.~\cite{kuroda_etal_2016} use the Levermore closure.  
...
\ee{so what?  Should we discuss the presence of blocking factors in collision terms?}

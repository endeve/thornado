...
It can be shown that $\bcM_{i}^{n+1}$ remains realizable given $\bcM_{i}^{n}$ is realizable, $\eta \in [0,1]$ and $\cC(\bcM)$ is positivity-preserving. The proof can be found in \cite{c
chu_2018}.

...
In the middle column, we can see how the neutrinos are generated near the core, stream out, and reach an equilibrium distribution over the phase space eventually.
In the right column, we can see how the scattering reshapes the flux direction. 
The oscillatory behavior, which is more obvious for high-energy groups, is caused by machine accuracy error.

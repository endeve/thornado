...
CONTAINS
  ...
  SUBROUTINE ComputeIncrement_TwoMoment_Implicit_New &
    ...
    WRITE(*,'(a20,7i4,2es23.15)') 'MINLOC(dU_F), MINVAL(dU_F)', MINLOC(dU_F), MINVAL(dU_F)
    WRITE(*,'(a20,7i4,2es23.15)') 'MAXLOC(dU_F), MAXVAL(dU_F)', MAXLOC(dU_F), MAXVAL(dU_F)
    WRITE(*,'(a20,7i4,2es23.15)') 'MINLOC(dU_R), MINVAL(dU_F)', MINLOC(dU_R), MINVAL(dU_R)
    WRITE(*,'(a20,7i4,2es23.15)') 'MAXLOC(dU_R), MAXVAL(dU_F)', MAXLOC(dU_R), MAXVAL(dU_R)
#endif

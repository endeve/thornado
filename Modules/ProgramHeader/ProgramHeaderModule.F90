MODULE ProgramHeaderModule
  ...
  !$OMP DECLARE &
  !$OMP TARGET( nX, swX, bcX, xL, xR, zoomX, nNodesX, &
  !$OMP         nZ, nNodesZ, swZ, bcZ, zL, zR, zoomZ, iZ_B0, iZ_E0, iZ_B1, iZ_E1 )
#elif defined(THORNADO_OACC)
  !$ACC DECLARE &
  !$ACC CREATE( nX, swX, bcX, xL, xR, zoomX, nNodesX, &
  !$ACC         nZ, nNodesZ, swZ, bcZ, zL, zR, zoomZ, iZ_B0, iZ_E0, iZ_B1, iZ_E1 )
#endif
...
#if defined(THORNADO_OMP_OL)
    !$OMP TARGET UPDATE &
    !$OMP TO( nX, swX, bcX, xL, xR, zoomX, nNodesX )
#elif defined(THORNADO_OACC)
    !$ACC UPDATE &
    !$ACC DEVICE( nX, swX, bcX, xL, xR, zoomX, nNodesX )
#endif
...
#if defined(THORNADO_OMP_OL)
    !$OMP TARGET UPDATE &
    !$OMP TO( nZ, nNodesZ, swZ, bcZ, zL, zR, zoomZ, iZ_B0, iZ_E0, iZ_B1, iZ_E1 )
#elif defined(THORNADO_OACC)
    !$ACC UPDATE &
    !$ACC DEVICE( nZ, nNodesZ, swZ, bcZ, zL, zR, zoomZ, iZ_B0, iZ_E0, iZ_B1, iZ_E1 )
#endif

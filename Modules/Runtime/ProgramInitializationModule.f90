MODULE ProgramInitializationModule
  ...
  USE MagnetofluidFieldsModule, ONLY: &
    CreateMagnetofluidFields, &
    DestroyMagnetofluidFields
  ...
  PUBLIC :: InitializeProgram_Basic
  PUBLIC :: InitializeProgram
  PUBLIC :: FinalizeProgram_Basic
  PUBLIC :: FinalizeProgram

CONTAINS


  SUBROUTINE InitializeProgram_Basic &
    ( ProgramName_Option, nX_Option, swX_Option, bcX_Option, xL_Option, &
      ...
      nNodes_Option, ActivateUnits_Option, UseMHD_Option, nSpecies_Option )
    ...
    LOGICAL,                INTENT(in), OPTIONAL :: UseMHD_Option
    ...
    IF( UseMHD_Option )THEN

      CALL CreateMagnetofluidFields &
             ( nX, swX, CoordinateSystem_Option = CoordinateSystem_Option )
  ...
  END SUBROUTINE InitializeProgram_Basic


  SUBROUTINE FinalizeProgram_Basic( UseMHD_Option )
    ...
    IF( UseMHD_Option )THEN
      ...
      CALL DestroyMagnetofluidFields
  ...
  END SUBROUTINE FinalizeProgram_Basic

MODULE Euler_CharacteristicDecompositionModule_TABLE_NonRelativistic
  ...
  PUBLIC :: Euler_ComputeCharacteristicDecomposition_TABLE_NonRelativistic

CONTAINS


  SUBROUTINE Euler_ComputeCharacteristicDecomposition_TABLE_NonRelativistic &
    ( iDim, G, U, R, invR )
  ...
  END SUBROUTINE Euler_ComputeCharacteristicDecomposition_TABLE_NonRelativistic


END MODULE Euler_CharacteristicDecompositionModule_TABLE_NonRelativistic

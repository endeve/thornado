...
CONTAINS
  ...
  SUBROUTINE ApplySlopeLimiter_Euler_NonRelativistic_TABLE &
    ...
    IF( .NOT. SuppressBC )THEN
      ...
      CALL DescribeError_Euler &
             ( iErr, 'Calling from: ApplySlopeLimiter_NonRelativistic_TABLE' )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      IF( ALL( D(:,iX1,iX2,iX3,iDF_Sh) < LimiterThreshold ) ) CYCLE
  ...
  SUBROUTINE DetectTroubledCells( iX_B0, iX_E0, iX_B1, iX_E1, U, D )

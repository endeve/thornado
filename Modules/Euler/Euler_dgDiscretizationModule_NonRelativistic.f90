MODULE Euler_dgDiscretizationModule_NonRelativistic
  ...
  PUBLIC :: Euler_ComputeIncrement_DG_Explicit_NonRelativistic
...
CONTAINS
  ...
  SUBROUTINE Euler_ComputeIncrement_DG_Explicit_NonRelativistic &
  ...
  END SUBROUTINE Euler_ComputeIncrement_DG_Explicit_NonRelativistic
...
END MODULE Euler_dgDiscretizationModule_NonRelativistic

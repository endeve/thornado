...
!!$    ComputeCharacteristicDecomposition_Euler_Relativistic_TABLE
  ...
  PUBLIC :: InitializeSlopeLimiter_Euler_Relativistic_TABLE
...
CONTAINS
  ...
  SUBROUTINE InitializeSlopeLimiter_Euler_Relativistic_TABLE &
  ...
  END SUBROUTINE InitializeSlopeLimiter_Euler_Relativistic_TABLE
...
!!$  SUBROUTINE ApplySlopeLimiter_Euler_Relativistic_TABLE_old &
...
!!$!!$
!!$!!$        CALL ComputeCharacteristicDecomposition_Euler_Relativistic_TABLE &
...
!!$
!!$      LimitField &
!!$        = SlopeDifference > SlopeTolerance * ABS( U_M(:,0,1,iX1,iX2,iX3) )
!!$
...
!!$            ! --- Electron Density ---
!!$
!!$            U_M(iCF,0,2,iX1,iX2,iX3) &
!!$              = ( U_M(iCF_D,0,1,iX1,iX2,iX3) * dY(1) &
!!$                    + Y_M(0,1) * dU(iCF_D,1) ) &
!!$                  / AtomicMassUnit
!!$
!!$            IF( nDimsX > 1 ) &
!!$              U_M(iCF,0,3,iX1,iX2,iX3) &
!!$                = ( U_M(iCF_D,0,1,iX1,iX2,iX3) * dY(2) &
!!$                      + Y_M(0,1) * dU(iCF_D,2) ) &
!!$                    / AtomicMassUnit
!!$
!!$            IF( nDimsX > 2 ) &
!!$              U_M(iCF,0,4,iX1,iX2,iX3) &
!!$                = ( U_M(iCF_D,0,1,iX1,iX2,iX3) * dY(3) &
!!$                      + Y_M(0,1) * dU(iCF_D,3) ) &
!!$                    / AtomicMassUnit
!!$
!!$          END IF
...
!!$    END DO
!!$
!!$    CALL ApplyConservativeCorrection_old &
!!$           ( iX_B0, iX_E0, iX_B1, iX_E1, G, V_K, U, U_K, LimitedCell )
!!$
!!$    CALL TimersStop_Euler( Timer_Euler_SlopeLimiter )
!!$
!!$  END SUBROUTINE ApplySlopeLimiter_Euler_Relativistic_TABLE_old
  ...
  SUBROUTINE ApplySlopeLimiter_Euler_Relativistic_TABLE &
    ...
    ! --- Map Nodal to Modal for Ye compute cells ---
...
#elif defined(THORNADO_OACC)
    !$ACC PARALLEL LOOP GANG VECTOR COLLAPSE(4) &
    !$ACC PRESENT( iX_B0, iX_E0, LimitedCell, D, U_M, SlopeDifference )
#elif defined(THORNADO_OMP)
    !$OMP PARALLEL DO COLLAPSE(4)
#endif
    DO iX3 = iX_B0(3), iX_E0(3)
    ...
    DO iCF = 1       , nCF
      ...
      IF( SlopeDifference(iCF,iX1,iX2,iX3) &
            .GT. SlopeTolerance * ABS( U_M(1,iCF,iX1,iX2,iX3) ) ) &
        LimitedCell(iCF,iX1,iX2,iX3) = .TRUE.
    ...
    !$ACC PRESENT( iX_B0, iX_E0, LimitedCell )
#elif defined(THORNADO_OMP)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      IF( LimitedCell(iCF_D,iX1,iX2,iX3) &
            .NEQV. LimitedCell(iCF_Ne,iX1,iX2,iX3) )THEN
    ...
    DO iCF = 1       , nCF
      ...
      END IF ! LimitedCell(iCF,iX1,iX2,iX3)
  ...
  END SUBROUTINE ApplySlopeLimiter_Euler_Relativistic_TABLE


  ! --- PRIVATE SUBROUTINES ---


!!$  SUBROUTINE ApplyConservativeCorrection_old &
!!$    ( iX_B0, iX_E0, iX_B1, iX_E1, G, V_K, U, U_K, LimitedCell )
!!$
!!$    INTEGER, INTENT(in)     :: &
!!$      iX_B0(3), iX_E0(3), iX_B1(3), iX_E1(3)
...
!!$    END DO
!!$
!!$  END SUBROUTINE ApplyConservativeCorrection_old
  ...
  END SUBROUTINE ComputeMinModArguments_Y_X1
  ...
  END SUBROUTINE ComputeMinModArguments_Y_X2
  ...
  END SUBROUTINE ComputeMinModArguments_Y_X3
...
END MODULE Euler_SlopeLimiterModule_Relativistic_TABLE

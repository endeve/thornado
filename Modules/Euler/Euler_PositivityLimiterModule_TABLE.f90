MODULE Euler_PositivityLimiterModule_TABLE
  ...
  PUBLIC :: Euler_InitializePositivityLimiter_TABLE
  PUBLIC :: Euler_FinalizePositivityLimiter_TABLE
  PUBLIC :: Euler_ApplyPositivityLimiter_TABLE
...
CONTAINS
  ...
  SUBROUTINE Euler_InitializePositivityLimiter_TABLE &
    ...
    IF( Verbose )THEN
      WRITE(*,*)
      WRITE(*,'(A2,A6,A)') '', 'INFO: ', 'Euler_PositivityLimiterModule_TABLE'
      WRITE(*,'(A2,A)') '',    '-------------------------------------------'
      WRITE(*,*)
      WRITE(*,'(A6,A,L1)') &
  ...
  END SUBROUTINE Euler_InitializePositivityLimiter_TABLE


  SUBROUTINE Euler_FinalizePositivityLimiter_TABLE

    DEALLOCATE( U_PP )

  END SUBROUTINE Euler_FinalizePositivityLimiter_TABLE


  SUBROUTINE Euler_ApplyPositivityLimiter_TABLE &
  ...
  END SUBROUTINE Euler_ApplyPositivityLimiter_TABLE
...
END MODULE Euler_PositivityLimiterModule_TABLE

MODULE ReferenceElementModule
  ...
  INTEGER,  DIMENSION(:,:), ALLOCATABLE, PUBLIC :: NodeNumberTable1D3D
  INTEGER,  DIMENSION(:,:), ALLOCATABLE, PUBLIC :: NodeNumberTable1D3D_X1
  INTEGER,  DIMENSION(:,:), ALLOCATABLE, PUBLIC :: NodeNumberTable1D3D_X2
  INTEGER,  DIMENSION(:,:), ALLOCATABLE, PUBLIC :: NodeNumberTable1D3D_X3
  ...
  REAL(DP), DIMENSION(:),   ALLOCATABLE, PUBLIC :: Weights_q
  REAL(DP), DIMENSION(:),   ALLOCATABLE, PUBLIC :: Weights_X1
  REAL(DP), DIMENSION(:,:), ALLOCATABLE, PUBLIC :: Nodes_q

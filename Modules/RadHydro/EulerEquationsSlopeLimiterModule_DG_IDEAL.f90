MODULE EulerEquationsSlopeLimiterModule_DG_IDEAL
  ...
  PUBLIC :: ApplySlopeLimiter_Euler_DG_IDEAL

CONTAINS


  SUBROUTINE ApplySlopeLimiter_Euler_DG_IDEAL
    ...
    IF( Debug )THEN
      WRITE(*,*)
      WRITE(*,'(A6,A)') '', 'ApplySlopeLimiter_Euler_DG_IDEAL'
      WRITE(*,*)
    END IF
    ...
    IF( Debug )THEN
      WRITE(*,*)
      WRITE(*,'(A6,A)') '', 'ApplySlopeLimiter_Euler_DG_IDEAL Done'
      WRITE(*,*)
    END IF

  END SUBROUTINE ApplySlopeLimiter_Euler_DG_IDEAL


END MODULE EulerEquationsSlopeLimiterModule_DG_IDEAL

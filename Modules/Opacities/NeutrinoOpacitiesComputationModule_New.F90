...
MODULE NeutrinoOpacitiesComputationModule_New
...
CONTAINS
  ...
  SUBROUTINE ComputeNeutrinoOpacities_NES_Point_1 &
    ( iE_B, iE_E, D, T, Y, iSpecies, iMoment, H1, H2 )
#if defined(THORNADO_OMP_OL)
    !$OMP DECLARE TARGET
#elif defined(THORNADO_OACC)
    !$ACC ROUTINE SEQ
  ...
  SUBROUTINE ComputeNeutrinoOpacities_NES_Points_1 &
    ( iE_B, iE_E, iX_B, iX_E, D, T, Y, iSpecies, iMoment, H1, H2 )
  ...
  SUBROUTINE ComputeNeutrinoOpacityRates_NES_Points &
    ...
    IF ( .not. do_gpu ) THEN
      ...
      IF ( .not. QueryOnGPU( J0 ) ) &
        WRITE(*,*) '[ComputeNeutrinoOpacitiesRates_NES_Points]   J0 missing'
      ...
      IF ( .not. QueryOnGPU( H1 ) ) &
        WRITE(*,*) '[ComputeNeutrinoOpacitiesRates_NES_Points]   H1 missing'
      IF ( .not. QueryOnGPU( H2 ) ) &
        WRITE(*,*) '[ComputeNeutrinoOpacitiesRates_NES_Points]   H2 missing'
    END IF
#endif
  ...
  SUBROUTINE ComputeNeutrinoOpacities_Pair_Points_1 &
    ...
    !$ACC IF( do_gpu ) &
    !$ACC PRIVATE( kT, DetBal ) &
    !$ACC PRESENT( E, T, Phi_In, Phi_Out, J1, J2, C1, C2 )
#endif
    DO iX = iX_B, iX_E
      DO iE2 = iE_B, iE_E
        DO iE1 = iE_B, iE_E
...
END MODULE NeutrinoOpacitiesComputationModule_New

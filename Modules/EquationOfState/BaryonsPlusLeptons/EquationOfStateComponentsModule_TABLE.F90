...
MODULE EquationOfStateComponentsModule_TABLE
  ...
  PUBLIC :: ApplyChemicalPotentialShifTbary_TABLE
  ...
  PUBLIC :: ComputeElectronMuonNeutrinoChemicalPotential_TABLE
  ...
  INTERFACE ComputeElectronMuonNeutrinoChemicalPotential_TABLE
    MODULE PROCEDURE ComputeElectronMuonNeutrinoChemicalPotential_TABLE_Scalar
    MODULE PROCEDURE ComputeElectronMuonNeutrinoChemicalPotential_TABLE_Vector
  END INTERFACE
...
CONTAINS
  ...
  SUBROUTINE InitializeEquationOfState_TABLE &
    ...
    IF ( UseChemicalPotentialShift ) CALL ApplyChemicalPotentialShifTbary_TABLE( Mpbary_T, Mnbary_T, OS_Mp, OS_Mn )
  ...
  SUBROUTINE ApplyChemicalPotentialShifTbary_TABLE( Mpbary_T, Mnbary_T, OS_Mp, OS_Mn )
  ...
  END SUBROUTINE ApplyChemicalPotentialShifTbary_TABLE
  ...
  SUBROUTINE ComputeTemperatureFromSpecificInternalEnergy_TABLE_Scalar_G_E &
    ...
    REAL(DP) :: D_P, E_P, Yp_P, Ye_P, Ymu_P, T_Lookup, T_Guess
  ...
  SUBROUTINE ComputePressureFromPrimitive_TABLE_Scalar( D, Ev, Ne, Nmu, P )
  ...
  SUBROUTINE ComputePressureFromPrimitive_TABLE_Vector( D, Ev, Ne, Nmu, P )
  ...
  SUBROUTINE ComputeSoundSpeedFromPrimitive_TABLE_Vector( D, Ev, Ne, Nmu, Cs )
  ...
  SUBROUTINE ComputeTemperatureFromPressure_TABLE_Scalar( D, P, Yp, Ye, Ym, T )
    ...
    INTEGER  :: Error
    REAL(DP) :: D_P, P_P, Yp_P, Ye_P, Ymu_P, T_P
...
#if defined(THORNADO_OMP_OL)
          !$OMP TARGET UPDATE FROM &
          !$OMP ( D(iP), Em(iP), Yp(iP) )
#elif defined(THORNADO_OACC)
          !$ACC UPDATE HOST &
          !$ACC ( D(iP), Em(iP), Yp(iP) )
#endif
          D_P = D(iP)  / ( Gram / Centimeter**3 )
          E_P = Em(iP) / ( Erg / Gram )
          Yp_P = Yp(iP)
  ...
  SUBROUTINE ComputeProtonChemicalPotential_TABLE_Scalar &
    ...
    IF ( ComputeDerivatives ) THEN
      ...
      CALL ComputeDependentVariableAndDerivativesBaryons_TABLE_Scalar &
             ( D, T, Yp, M, dMdD, dMdT, dMdY, Mpbary_T, OS_Mp, UnitMp )
  ...
  SUBROUTINE ComputeNeutronChemicalPotential_TABLE_Scalar &
    ...
    IF( ComputeDerivatives )THEN
      ...
      CALL ComputeDependentVariableAndDerivativesBaryons_TABLE_Scalar &
             ( D, T, Yp, M, dMdD, dMdT, dMdY, Mnbary_T, OS_Mn, UnitMn )
  ...
  SUBROUTINE ComputeProtonMassFraction_TABLE_Scalar &
    ( D, T, Yp, X, dXdD_Option, dXdT_Option, dXdY_Option )
    ...
    IF ( ComputeDerivatives ) THEN
      ...
      CALL ComputeDependentVariableAndDerivativesBaryons_TABLE_Scalar &
             ( D, T, Yp, X, dXdD, dXdT, dXdY, Xpbary_T, OS_Xp, UnitXp )
  ...
  SUBROUTINE ComputeNeutronMassFraction_TABLE_Scalar &
    ...
    IF( ComputeDerivatives )THEN
      ...
      CALL ComputeDependentVariableAndDerivativesBaryons_TABLE_Scalar &
             ( D, T, Yp, X, dXdD, dXdT, dXdY, Xnbary_T, OS_Xn, UnitXn )
  ...
  END SUBROUTINE ComputeElectronMuonNeutrinoChemicalPotential_TABLE_Scalar
  ...
  END SUBROUTINE ComputeElectronMuonNeutrinoChemicalPotential_TABLE_Vector

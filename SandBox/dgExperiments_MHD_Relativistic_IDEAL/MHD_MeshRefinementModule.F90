MODULE MHD_MeshRefinementModule
  ...
  PUBLIC :: InitializeMeshRefinement_MHD
  PUBLIC :: FinalizeMeshRefinement_MHD
  PUBLIC :: Refine_MHD
  PUBLIC :: Coarsen_MHD
...
CONTAINS
  ...
  SUBROUTINE InitializeMeshRefinement_MHD
...
!!$    CALL PrintNodeNumberTableX_X_Mapping
  ...
  END SUBROUTINE InitializeMeshRefinement_MHD


  SUBROUTINE FinalizeMeshRefinement_MHD
  ...
  END SUBROUTINE FinalizeMeshRefinement_MHD


  SUBROUTINE Refine_MHD( nX, U_Crs, U_Fin )
  ...
  END SUBROUTINE Refine_MHD


  SUBROUTINE Coarsen_MHD( nX, U_Crs, U_Fin )
...
END MODULE MHD_MeshRefinementModule

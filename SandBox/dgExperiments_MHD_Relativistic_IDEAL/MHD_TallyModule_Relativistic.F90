MODULE MHD_TallyModule_Relativistic
  ...
  PUBLIC :: InitializeTally_MHD_Relativistic
  PUBLIC :: ComputeTally_MHD_Relativistic
  PUBLIC :: IncrementOffGridTally_MHD_Relativistic
  PUBLIC :: FinalizeTally_MHD_Relativistic
...
CONTAINS
  ...
  SUBROUTINE InitializeTally_MHD_Relativistic &
  ...
  END SUBROUTINE InitializeTally_MHD_Relativistic


  SUBROUTINE ComputeTally_MHD_Relativistic &
    ...
    CALL ComputeTally_MHD( iX_B0, iX_E0, iX_B1, iX_E1, G, U )
  ...
  END SUBROUTINE ComputeTally_MHD_Relativistic


  SUBROUTINE ComputeTally_MHD( iX_B0, iX_E0, iX_B1, iX_E1, G, U )
  ...
  SUBROUTINE IncrementOffGridTally_MHD_Relativistic( dM )

    REAL(DP), INTENT(in) :: dM(nCM)

    BaryonicMass_OffGrid &
      = BaryonicMass_OffGrid + dM(iCM_D)

    Energy_OffGrid &
      = Energy_OffGrid + dM(iCM_E)

  END SUBROUTINE IncrementOffGridTally_MHD_Relativistic
  ...
  SUBROUTINE FinalizeTally_MHD_Relativistic

  END SUBROUTINE FinalizeTally_MHD_Relativistic


END MODULE MHD_TallyModule_Relativistic

PROGRAM ApplicationDriver_Neutrinos_SG
  ...
  USE TwoMoment_DiscretizationModule_Collisions_Neutrinos_OrderV_SG, ONLY: &
  ...
  CHARACTER(128) :: OpacityGridName_EmAb
  CHARACTER(128) :: OpacityGridName_Iso
  CHARACTER(128) :: OpacityGridName_NES
  CHARACTER(128) :: OpacityGridName_Pair
  LOGICAL       :: EvolveEuler
  ...
  SUBROUTINE InitializeDriver
    ...
    CALL InitializeSparseGridOpacities &
         ( OpacityGridName_EmAb_Option &
             = TRIM( OpacityGridName_EmAb ), &
           OpacityGridName_Iso_Option &
             = TRIM( OpacityGridName_Iso ), &
           OpacityGridName_NES_Option &
             = TRIM( OpacityGridName_NES ), &
           OpacityGridName_Pair_Option &
             = TRIM( OpacityGridName_Pair ) )
...
END PROGRAM ApplicationDriver_Neutrinos_SG

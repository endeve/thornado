PROGRAM Relaxation
  ...
  !            = 'SGOpacities/reduced_EmAb_log_trunc_20.grid', &
  !          OpacityGridName_Iso_Option &
  !            = 'SGOpacities/reduced_IS_log_trunc_20.grid', &
  !          OpacityGridName_NES_Option &
  !            = 'SGOpacities/reduced_NES_log_trunc_20.grid', &
  !          OpacityGridName_Pair_Option &
  !            = 'SGOpacities/reduced_PAIR_log_trunc_20.grid' )

  CALL InitializeSparseGridOpacities &
         ( OpacityGridName_EmAb_Option &
             = 'SGOpacities/reduced_EmAb_threshold_0.0001_log_trunc_20.grid', &
           OpacityGridName_Iso_Option &

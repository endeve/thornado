...
MODULE TwoMoment_DiscretizationModule_Collisions_Neutrinos
  ...
  USE NeutrinoOpacitiesSparseComputationModule, ONLY: &
    ...
    ComputeNeutrinoOpacities_NES_Point_SG, &
    ComputeNeutrinoOpacities_Pair_Point_SG
...
CONTAINS
  ...
  SUBROUTINE SolveMatterEquations_FP_Coupled &
    ...
    DO WHILE( .NOT. CONVERGED .AND. k < MaxIter )
      ...
      CALL ComputeNeutrinoOpacities_NES_Point_SG &
             (1, nE_G, E_N, D, T, Y, iS_1, iS_2, 1, &
               Phi_0_In_NES(:,:,1), Phi_0_Ot_NES(:,:,1), &
               Phi_0_In_NES(:,:,2), Phi_0_Ot_NES(:,:,2) )
      ! --- Pair Kernels ---
      ...
      CALL ComputeNeutrinoOpacities_Pair_Point_SG &
             (1, nE_G, E_N, D, T, Y, iS_1, iS_2, 1, &
               Phi_0_In_Pair(:,:,1), Phi_0_Ot_Pair(:,:,1), &
               Phi_0_In_Pair(:,:,2), Phi_0_Ot_Pair(:,:,2) )

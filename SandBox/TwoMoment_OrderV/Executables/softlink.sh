#!/bin/bash
WEAKLIB_TABLES_DIR='/home/mthavappiragasam/lcf/ExaStar//weaklib-tables'
...
#ln -s $WEAKLIB_TABLES_DIR/SFHo/LowRes/wl-EOS-SFHo-15-25-50.h5 EquationOfStateTable.h5 ## Legacy one: wrong

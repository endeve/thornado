...
BASE_CMP_DATE="2023.08.20"
BASE_MKL_DATE="2023.08.28"
BASE_UMD="-dev627"
export AADEBUG=""
...
if [[ -z $ACTION || "$1" == "FOM" ]];then
   ...
   echo "                     MKL Date :  $MKL_DATE               $BASE_MKL_DATE">>$timeFOMLog
...
do
   ...
   do
      ...
      do 
         ...
         export LOG_BASE=${logFiles[jj]}.${OP_LEVEL}.${BASE_CMP_DATE}-${BASE_MKL_DATE}${BASE_UMD}${gridNames[ii]}$AADEBUG

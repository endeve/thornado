...
CONTAINS
  ...
  SUBROUTINE TagElements_Advection1D &
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      indLo = 1 + nDOFX * ( iCM_D - 1 )
      indHi = nDOFX * iCM_D

!      IF( MeshX(1) % Center(iX1) .GT. TagCriteria_this )THEN
      IF( ANY( uCM(iX1,iX2,iX3,indLo:indHi) .GT. TagCriteria_this ) )THEN
  ...
  SUBROUTINE TagElements_RiemannProblem1D &
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      GradD = ( (   uCM(iX1+1,iX2,iX3,indLo:indHi) &
                  - uCM(iX1-1,iX2,iX3,indLo:indHi) ) )**2! &
!                / ( Two * MeshX(1) % Width(iX1) ) )**2
  ...
  SUBROUTINE TagElements_RiemannProblem2D &
    ( iLevel, iX_B0, iX_E0, iLo, iHi, uCM, TagCriteria, &
      SetTag, ClearTag, TagLo, TagHi, Tag )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      GradD_X1 = ABS(   uCM(iX1+1,iX2,iX3,indLo:indHi) &
                      - uCM(iX1-1,iX2,iX3,indLo:indHi) ) &
                   / ( Two * MeshX(1) % Width(iX1) )
      GradD_X2 = ABS(   uCM(iX1,iX2+1,iX3,indLo:indHi) &
                      - uCM(iX1,iX2-1,iX3,indLo:indHi) ) &
  ...
  END SUBROUTINE TagElements_RiemannProblem2D
...
!!$           .AND. ( MeshX(2) % Center(iX2) .GT. TagCriteria_this ) )THEN
  ...
  SUBROUTINE TagElements_KelvinHelmholtz2D &
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      GradD = GradD &
                + ( (   uCM(iX1,iX2+1,iX3,indLo:indHi) &
                      - uCM(iX1,iX2-1,iX3,indLo:indHi) ) )**2
...
!           .AND. ( MeshX(3) % Center(iX3) .GT. TagCriteria_this ) )THEN
  ...
  END SUBROUTINE TagElements_uCM

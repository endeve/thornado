...
CONTAINS
  ...
  SUBROUTINE ComputeIncrement_TwoMoment_Explicit &
    ...
    LOGICAL  :: SuppressBC
    REAL(DP) :: &
      dU_R_OLD(1:nDOFZ,iZ_B1(1):iZ_E1(1),iZ_B1(2):iZ_E1(2), &
                   iZ_B1(3):iZ_E1(3),iZ_B1(4):iZ_E1(4),1:nCR,1:nSpecies)
    ...
    DO iZ1 = iZ_B1(1), iZ_E1(1)
      ...
      DO iNodeZ = 1, nDOFZ
        ...
        dU_R_OLD(iNodeZ,iZ1,iZ2,iZ3,iZ4,iCR,iS) = Zero
    ...
    dU_R_OLD = dU_R
    CALL ComputeIncrement_ObserverCorrections_NEW &
           ( iZ_B0, iZ_E0, iZ_B1, iZ_E1, &
...
!          dU_R(iNodeZ,iZ1,iZ2,iZ3,iZ4,1,iS) , dU_R_OLD(iNodeZ,iZ1,iZ2,iZ3,iZ4,1,iS), &
!          dU_R(iNodeZ,iZ1,iZ2,iZ3,iZ4,4,iS) , dU_R_OLD(iNodeZ,iZ1,iZ2,iZ3,iZ4,4,iS)
!     END IF
!      END DO
!      END DO
!
  ...
  SUBROUTINE ComputeIncrement_Divergence_X2 &
    ...
    DO iZ2  = iZ_B0(2), iZ_E0(2)
      ...
      DO iNodeX = 1, nDOFX_X2
        ...
        ! --- Left State ---
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_L(iNodeX,iZ2,iZ4,iZ3,iCF_D ), &
                 uCF_L(iNodeX,iZ2,iZ4,iZ3,iCF_S1), &
                 uCF_L(iNodeX,iZ2,iZ4,iZ3,iCF_S2), &
        ...
        ! --- Right State ---
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_R(iNodeX,iZ2,iZ4,iZ3,iCF_D ), &
                 uCF_R(iNodeX,iZ2,iZ4,iZ3,iCF_S1), &
                 uCF_R(iNodeX,iZ2,iZ4,iZ3,iCF_S2), &
...
!check to make sure this is right
      ...
      iX_F = iNodeX &
             ...
             + ( iZ4 - iZP_B0(3) ) * nDOFX_X2 * nZP_X(2) &
             + ( iZ3 - iZP_B0(4) ) * nDOFX_X2 * nZP_X(2) * nZP_X(3)
    ...
    DO iZ2 = iZ_B0(2), iZ_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        iX_K = iNodeX &
             + ( iZ2 - iZP_B0(2) ) * nDOFX &
             + ( iZ4 - iZP_B0(3) ) * nDOFX * nZP(2) &
             + ( iZ3 - iZP_B0(4) ) * nDOFX * nZP(2) * nZP(3)

        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_K(iNodeX      ,iZ2,iZ4,iZ3,iCF_D ), &
                 uCF_K(iNodeX      ,iZ2,iZ4,iZ3,iCF_S1), &
                 uCF_K(iNodeX      ,iZ2,iZ4,iZ3,iCF_S2), &
  ...
  SUBROUTINE ComputeIncrement_Divergence_X3 &
    ...
    DO iZ2  = iZ_B0(2), iZ_E0(2)
      ...
      DO iNodeX = 1, nDOFX_X3
        ...
        ! --- Left State ---
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_L(iNodeX,iZ2,iZ3,iZ4,iCF_D ), &
                 uCF_L(iNodeX,iZ2,iZ3,iZ4,iCF_S1), &
                 uCF_L(iNodeX,iZ2,iZ3,iZ4,iCF_S2), &
        ...
        ! --- Right State ---
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_R(iNodeX,iZ2,iZ3,iZ4,iCF_D ), &
                 uCF_R(iNodeX,iZ2,iZ3,iZ4,iCF_S1), &
                 uCF_R(iNodeX,iZ2,iZ3,iZ4,iCF_S2), &
...
!check to make sure this is right
      ...
      iX_F = iNodeX &
             + ( iZ2 - iZP_B0(2) ) * nDOFX_X3 &
             + ( iZ3 - iZP_B0(3) ) * nDOFX_X3 * nZP_X(2) &
             + ( iZ4 - iZP_B0(4) ) * nDOFX_X3 * nZP_X(2) * nZP_X(3)
    ...
    DO iZ2 = iZ_B0(2), iZ_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        iX_K = iNodeX &
             + ( iZ2 - iZP_B0(2) ) * nDOFX &
             + ( iZ3 - iZP_B0(3) ) * nDOFX * nZP(2) &
             + ( iZ4 - iZP_B0(4) ) * nDOFX * nZP(2) * nZP(3)
  ...
  SUBROUTINE ComputeIncrement_ObserverCorrections &
    ( iZ_B0, iZ_E0, iZ_B1, iZ_E1, &
      iX_B0, iX_E0, iX_B1, iX_E1, &
      GE, GX, U_F, U_R, dU_R, Verbose_Option )
    ...
    CALL ComputeGeometryDerivatives_X0 &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, dG_dd_dX0, &
             Verbose_Option = Verbose )
    ...
    CALL ComputeWeakDerivatives_X1 &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, U_F, Gamma_udd, dU_d_dX1, dU_d_dX1_COV, &
             Verbose_Option = Verbose )
    
    CALL ComputeWeakDerivatives_X2 &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, U_F, Gamma_udd,  dU_d_dX2, dU_d_dX2_COV, &
             Verbose_Option = Verbose )
    CALL ComputeWeakDerivatives_X3 &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, U_F, Gamma_udd, dU_d_dX3, dU_d_dX3_COV, &
             Verbose_Option = Verbose )


    CALL ComputeFourVelocity &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, U_F, U_u, U_d, uPF_K, &
             Verbose_Option = Verbose  )
...
!!             Flux_q, nDOFZ, One, dU_E, nDOFZ )
  ...
  SUBROUTINE ComputeIncrement_ObserverCorrections_NEW &
    ( iZ_B0, iZ_E0, iZ_B1, iZ_E1, & 
      iX_B0, iX_E0, iX_B1, iX_E1, &
      GE, GX, U_F, U_R, dU_R, Verbose_Option )
    ...
    REAL(DP) :: Flux_K(nCR), uPF_K(nPF)
    REAL(DP) :: Flux_L(nCR), uPR_L(nPR)
    REAL(DP) :: Flux_R(nCR), uPR_R(nPR), W, S_E(3), C
    ...
    CALL ComputeFourVelocity &
           ( iX_B0, iX_E0, iX_B1, iX_E1, GX, U_F, U_u, U_d, &
             Verbose_Option = Verbose  )
    ...
    DO iZ2 = iZ_B0(2), iZ_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        ! --- Quadratic Form Matrix ---
          ...
          CALL ComputeAlpha( uV1_K(iX_K), uV2_K(iX_K), uV3_K(iX_K), & 
                             Gm_dd_11_K(iX_K), Gm_dd_22_K(iX_K), Gm_dd_33_K(iX_K), &
                             U_u(iNodeX,:,iZ2,iZ3,iZ4), &
                             dU_d_dX0(iNodeX,:,iZ2,iZ3,iZ4), &
                             dU_d_dX1(iNodeX,:,iZ2,iZ3,iZ4), &
    ...
    DO iZ_F = 1, nNodesZ_E
      ...
      Flux_L &
        = Flux_E( uD_L (iZ_F), uI1_L(iZ_F), uI2_L(iZ_F), uI3_L(iZ_F), &
                  ...
                  G_Alpha_K(iX_F), G_Beta_1_K(iX_F), G_Beta_2_K(iX_F), G_Beta_3_K(iX_F), &
                  U_u(iNodeZ_E,:,iZ2,iZ3,iZ4), &
                  dU_d_dX0_COV(iNodeZ_E,:,iZ2,iZ3,iZ4), &
                  dU_d_dX1_COV(iNodeZ_E,:,iZ2,iZ3,iZ4), &
                  dU_d_dX2_COV(iNodeZ_E,:,iZ2,iZ3,iZ4), &
                  dU_d_dX3_COV(iNodeZ_E,:,iZ2,iZ3,iZ4) )
      ...
      W = 1.0_DP - ( Gm_dd_11_K(iX_F) * uV1_K(iX_F)**2 &
                 +   Gm_dd_22_K(iX_F) * uV2_K(iX_F)**2 & 
                 +   Gm_dd_33_K(iX_F) * uV3_K(iX_F)**2 )
      W = 1.0_DP / SQRT(W)
      ...
      DO iCR = 1, nCR
        ...
        NumericalFlux(iNodeZ_E,iCR,iZ2,iZ3,iZ4,iS,iZ1) &
          = NumericalFlux_LLF &
              ( W * uPR_L(iCR), W * uPR_R(iCR), Flux_L(iCR), Flux_R(iCR), &
  ...
  ! --- Contribution from Right Face ---
    ...
    DO iZ_K = 1, nNodesZ_K
      ...
      Flux_K &
        = Flux_E( uD_K (iZ_K), uI1_K(iZ_K), uI2_K(iZ_K), uI3_K(iZ_K), &
                  uV1_K(iX_K), uV2_K(iX_K), uV3_K(iX_K), &
                  Gm_dd_11_K(iX_K), Gm_dd_22_K(iX_K), Gm_dd_33_K(iX_K), &
                  G_Alpha_K(iX_K), G_Beta_1_K(iX_K), G_Beta_2_K(iX_K), G_Beta_3_K(iX_K), &
                  U_u(iNodeX,:,iZ2,iZ3,iZ4), &
                  dU_d_dX0_COV(iNodeX,:,iZ2,iZ3,iZ4), &
                  dU_d_dX1_COV(iNodeX,:,iZ2,iZ3,iZ4), &
                  dU_d_dX2_COV(iNodeX,:,iZ2,iZ3,iZ4), &
   ...
   CALL MatrixMatrixMultiply &
    ...
    DO iZ_K = 1, nNodesZ_K
      ...
      S_E &
        = Source_E( uD_K (iZ_K), uI1_K(iZ_K), uI2_K(iZ_K), uI3_K(iZ_K), &
                  uV1_K(iX_K), uV2_K(iX_K), uV3_K(iX_K), &
                  Gm_dd_11_K(iX_K), Gm_dd_22_K(iX_K), Gm_dd_33_K(iX_K), &
                  G_Alpha_K(iX_K), G_Beta_1_K(iX_K), G_Beta_2_K(iX_K), G_Beta_3_K(iX_K), &
                  U_u(iNodeX,:,iZ2,iZ3,iZ4), &
  ...
  END SUBROUTINE ComputeIncrement_ObserverCorrections_NEW
  ...
  FUNCTION FaceVelocity_X1_OLD &
    ( V1_L, V2_L, V3_L, V1_R, V2_R, V3_R )

    REAL(DP), INTENT(in) :: V1_L, V2_L, V3_L
    REAL(DP), INTENT(in) :: V1_R, V2_R, V3_R
    REAL(DP)             :: FaceVelocity_X1_OLD(1:3)

    ! --- Average Left and Right States ---

    FaceVelocity_X1_OLD(1) = Half * ( V1_L + V1_R )
    FaceVelocity_X1_OLD(2) = Half * ( V2_L + V2_R )
    FaceVelocity_X1_OLD(3) = Half * ( V3_L + V3_R )

    RETURN
  END FUNCTION FaceVelocity_X1_OLD




  FUNCTION FaceVelocity_X2_OLD &
    ( V1_L, V2_L, V3_L, V1_R, V2_R, V3_R )

    REAL(DP), INTENT(in) :: V1_L, V2_L, V3_L
    REAL(DP), INTENT(in) :: V1_R, V2_R, V3_R
    REAL(DP)             :: FaceVelocity_X2_OLD(1:3)

    ! --- Average Left and Right States ---

    FaceVelocity_X2_OLD(1) = Half * ( V1_L + V1_R )
    FaceVelocity_X2_OLD(2) = Half * ( V2_L + V2_R )
    FaceVelocity_X2_OLD(3) = Half * ( V3_L + V3_R )

    RETURN
  END FUNCTION FaceVelocity_X2_OLD

  FUNCTION FaceVelocity_X3_OLD &
    ( V1_L, V2_L, V3_L, V1_R, V2_R, V3_R )

    REAL(DP), INTENT(in) :: V1_L, V2_L, V3_L
    REAL(DP), INTENT(in) :: V1_R, V2_R, V3_R
    REAL(DP)             :: FaceVelocity_X3_OLD(1:3)

    ! --- Average Left and Right States ---

    FaceVelocity_X3_OLD(1) = Half * ( V1_L + V1_R )
    FaceVelocity_X3_OLD(2) = Half * ( V2_L + V2_R )
    FaceVelocity_X3_OLD(3) = Half * ( V3_L + V3_R )

    RETURN
  END FUNCTION FaceVelocity_X3_OLD




  SUBROUTINE ComputeFourVelocity &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, uCF, U_u, U_d, uPF_Option, Verbose_Option  )
    ...
    REAL(DP), INTENT(out) :: &
      U_u(1:nDOFX,0:3, &
          iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3)) 
    REAL(DP), INTENT(out) :: &
      U_d(1:nDOFX,0:3, &
          iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3))
    REAL(DP), INTENT(out), OPTIONAL :: &
      uPF_Option(nDOFX,nPF, &
            iX_B0(1):iX_E0(1), &
            iX_B0(2):iX_E0(2), &
            iX_B0(3):iX_E0(3))
    LOGICAL,          INTENT(in), OPTIONAL :: Verbose_Option
    ...
    DO iX3 = iX_B0(3), iX_E0(3)
      ...
      DO iNodeX = 1, nDOFX
        ...
        V1 = uPF(iNodeX,iPF_V1,iX1,iX2,iX3)
        V2 = uPF(iNodeX,iPF_V2,iX1,iX2,iX3)
        V3 = uPF(iNodeX,iPF_V3,iX1,iX2,iX3)
        W =1.0_DP /SQRT( 1.0_DP - ( V1**2 * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11) &
           + V2**2 * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22) + V3**2 * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_33) ) )

        V_0 = GX (iNodeX,iX1,iX2,iX3,iGF_Beta_1) * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11) * V1 &
            + GX (iNodeX,iX1,iX2,iX3,iGF_Beta_2) * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22) * V2 &
            + GX (iNodeX,iX1,iX2,iX3,iGF_Beta_3) * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_33) * V3              
 
        U_u(iNodeX,0,iX1,iX2,iX3) = W * ( 1.0_DP / GX (iNodeX,iX1,iX2,iX3,iGF_Alpha) ) 
        U_u(iNodeX,1,iX1,iX2,iX3) = W * ( V1 - GX (iNodeX,iX1,iX2,iX3,iGF_Beta_1) / GX (iNodeX,iX1,iX2,iX3,iGF_Alpha) )
        U_u(iNodeX,2,iX1,iX2,iX3) = W * ( V2 - GX (iNodeX,iX1,iX2,iX3,iGF_Beta_2) / GX (iNodeX,iX1,iX2,iX3,iGF_Alpha) )
        U_u(iNodeX,3,iX1,iX2,iX3) = W * ( V3 - GX (iNodeX,iX1,iX2,iX3,iGF_Beta_3) / GX (iNodeX,iX1,iX2,iX3,iGF_Alpha) )


        U_d(iNodeX,0,iX1,iX2,iX3) = W * ( - GX (iNodeX,iX1,iX2,iX3,iGF_Alpha) + V_0 )
        U_d(iNodeX,1,iX1,iX2,iX3) = W * GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11) * V1
  ...
  SUBROUTINE ComputeWeakDerivatives_X0 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, uCF, Gamma_udd, dU_d_dX0, dU_d_dX0_COV, Verbose_Option  )
    ...
    REAL(DP) :: &
      uPF_K(nPF), &
      U_d(nDOFX,4,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
            iX_B0(3):iX_E0(3))
    REAL(DP) :: V_u_K(3), V_d_K(3), A_K, B_u_K(3), B_d_K(3), W_K, Vsq_K
    LOGICAL :: Verbose
    INTEGER :: iNodeX, mu, iX1, iX2, iX3
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        A_K = GX (iNodeX,iX1,iX2,iX3,iGF_Alpha)


        B_u_K(1) = GX (iNodeX,iX1,iX2,iX3,iGF_Beta_1)
        B_u_K(2) = GX (iNodeX,iX1,iX2,iX3,iGF_Beta_2)
        B_u_K(3) = GX (iNodeX,iX1,iX2,iX3,iGF_Beta_3)


        B_d_K(1) =  GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11) * B_u_K(1)
        B_d_K(2) =  GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22) * B_u_K(2)
        B_d_K(3) =  GX (iNodeX,iX1,iX2,iX3,iGF_Gm_dd_33) * B_u_K(3)
        ...
        U_d(iNodeX,1,iX1,iX2,iX3) = W_K * ( -A_K + B_d_K(1) * V_u_K(1) &
                                              +    B_d_K(2) * V_u_K(2) &
                                              +    B_d_K(3) * V_u_K(3)  )


        U_d(iNodeX,2,iX1,iX2,iX3) = W_K * V_d_K(1) 


        U_d(iNodeX,3,iX1,iX2,iX3) = W_K * V_d_K(2) 


        U_d(iNodeX,4,iX1,iX2,iX3) = W_K * V_d_K(3) 
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO mu = 0,3
        ...
        dU_d_dX0_COV(iNodeX,0,iX1,iX2,iX3)  &
        = dU_d_dX0_COV(iNodeX,0,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,0,0,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)


        dU_d_dX0_COV(iNodeX,1,iX1,iX2,iX3)  &
        = dU_d_dX0_COV(iNodeX,1,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,0,1,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)
    
        dU_d_dX0_COV(iNodeX,2,iX1,iX2,iX3)  &
        = dU_d_dX0_COV(iNodeX,2,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,0,2,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)
  ...
  SUBROUTINE ComputeWeakDerivatives_X1 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, uCF, Gamma_udd, dU_d_dX1, dU_d_dX1_COV, Verbose_Option  )
    ...
    INTEGER  :: nK(3), nK_X1(3), nX, nX_X1
    INTEGER  :: iNodeX
    INTEGER  :: iX1, iX2, iX3, iCF, iGF, mu
    REAL(DP) :: &
      uPF_K(nPF), uPF_L(nPF), uPF_R(nPF)
    REAL(DP) :: &
      GX_K(nDOFX   ,nGF,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
           iX_B1(1):iX_E1(1)), &
      GX_F(nDOFX_X1,nGF,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
           iX_B0(1):iX_E0(1)+1)
    REAL(DP) :: &
      uCF_K(nDOFX   ,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
            iX_B1(1):iX_E1(1)  ,nCF), &
      uCF_L(nDOFX_X1,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
            iX_B0(1):iX_E0(1)+1,nCF), &
      uCF_R(nDOFX_X1,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
            iX_B0(1):iX_E0(1)+1,nCF)
    REAL(DP) :: Vsq_X1, Vsq_K
    REAL(DP) :: V_u_K(3), V_d_K(3), V_u_X1(3), V_d_X1(3), W_X1, W_K
    REAL(DP) :: B_u_X1(3), B_d_X1(3), A_X1, B_u_K(3), B_d_K(3), A_K
    REAL(DP) :: &
      U_d_X1(nDOFX_X1,4,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
             iX_B0(1):iX_E0(1)+1), &
      U_d_K(nDOFX,4,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
            iX_B0(1):iX_E0(1)), &
      U_d(nDOFX,4,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
            iX_B0(1):iX_E0(1))
    REAL(DP) :: &
      dU_d_dX1_Temp &
         (1:nDOFX,4, &
          iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3),iX_B0(1):iX_E0(1)) 
    LOGICAL :: Verbose
    ...
    nK    = iX_E0 - iX_B0 + 1 ! Number of Elements per Phase Space Dimension
    nK_X1 = nK + [1,0,0]    ! Number of X1 Faces per Phase Space Dimension
    nX    = PRODUCT( nK   (1:3) ) ! Number of Elements in Position Space
    nX_X1 = PRODUCT( nK_X1(1:3) ) ! Number of X1 Faces in Position Space
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        uCF_K(iNodeX,iX2,iX3,iX1,iCF) = uCF(iNodeX,iX1,iX2,iX3,iCF)
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX_X1
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_L(iNodeX,iX2,iX3,iX1,iCF_D ), &
                 uCF_L(iNodeX,iX2,iX3,iX1,iCF_S1), &
                 uCF_L(iNodeX,iX2,iX3,iX1,iCF_S2), &
        ...
        ! --- Right States ---
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_R(iNodeX,iX2,iX3,iX1,iCF_D ), &
                 uCF_R(iNodeX,iX2,iX3,iX1,iCF_S1), &
                 uCF_R(iNodeX,iX2,iX3,iX1,iCF_S2), &
        ...
        A_X1 = GX_F(iNodeX,iGF_Alpha,iX2,iX3,iX1)

        B_u_X1(1) = GX_F(iNodeX,iGF_Beta_1,iX2,iX3,iX1)
        B_u_X1(2) = GX_F(iNodeX,iGF_Beta_2,iX2,iX3,iX1)
        B_u_X1(3) = GX_F(iNodeX,iGF_Beta_3,iX2,iX3,iX1)

        B_d_X1(1) = GX_F(iNodeX,iGF_Gm_dd_11,iX2,iX3,iX1) * B_u_X1(1)
        B_d_X1(2) = GX_F(iNodeX,iGF_Gm_dd_22,iX2,iX3,iX1) * B_u_X1(2)
        ...
        U_d_X1(iNodeX,2,iX2,iX3,iX1) = W_X1 * V_d_X1(1) 

        U_d_X1(iNodeX,3,iX2,iX3,iX1) = W_X1 * V_d_X1(2) 

        U_d_X1(iNodeX,4,iX2,iX3,iX1) = W_X1 * V_d_X1(3)
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X1, - One, LX_X1_Dn, nDOFX_X1, &
             U_d_X1(1,1,iX_B0(2),iX_B0(3),iX_B0(1)  ), nDOFX_X1, Zero, &
             dU_d_dX1_Temp, nDOFX )


    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X1, + One, LX_X1_Up, nDOFX_X1, &
             U_d_X1(1,1,iX_B0(2),iX_B0(3),iX_B0(1)+1), nDOFX_X1, One,  &
             dU_d_dX1_Temp, nDOFX )
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_K(iNodeX,iX2,iX3,iX1,iCF_D ), &
                 uCF_K(iNodeX,iX2,iX3,iX1,iCF_S1), &
                 uCF_K(iNodeX,iX2,iX3,iX1,iCF_S2), &
        ...
        A_K = GX_K(iNodeX,iGF_Alpha,iX2,iX3,iX1)

        B_u_K(1) =  GX_K(iNodeX,iGF_Beta_1,iX2,iX3,iX1)
        B_u_K(2) =  GX_K(iNodeX,iGF_Beta_2,iX2,iX3,iX1)
        B_u_K(3) =  GX_K(iNodeX,iGF_Beta_3,iX2,iX3,iX1)

        B_d_K(1) =  GX_K(iNodeX,iGF_Gm_dd_11,iX2,iX3,iX1) * B_u_K(1)
        B_d_K(2) =  GX_K(iNodeX,iGF_Gm_dd_22,iX2,iX3,iX1) * B_u_K(2)
        B_d_K(3) =  GX_K(iNodeX,iGF_Gm_dd_33,iX2,iX3,iX1) * B_u_K(3)
        ...
        U_d(iNodeX,2,iX2,iX3,iX1) = W_K * V_d_K(1) 

        U_d(iNodeX,3,iX2,iX3,iX1) = W_K * V_d_K(2) 

        U_d(iNodeX,4,iX2,iX3,iX1) = W_K * V_d_K(3) 



        U_d_K(iNodeX,1,iX2,iX3,iX1) = WeightsX_q(iNodeX) * U_d(iNodeX,1,iX2,iX3,iX1)
        U_d_K(iNodeX,2,iX2,iX3,iX1) = WeightsX_q(iNodeX) * U_d(iNodeX,2,iX2,iX3,iX1)
        U_d_K(iNodeX,3,iX2,iX3,iX1) = WeightsX_q(iNodeX) * U_d(iNodeX,3,iX2,iX3,iX1)
        U_d_K(iNodeX,4,iX2,iX3,iX1) = WeightsX_q(iNodeX) * U_d(iNodeX,4,iX2,iX3,iX1)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dU_d_dX1_COV(iNodeX,1,iX1,iX2,iX3)  &
          = dU_d_dX1_Temp(iNodeX,2,iX2,iX3,iX1)

        dU_d_dX1_COV(iNodeX,2,iX1,iX2,iX3)  &
          = dU_d_dX1_Temp(iNodeX,3,iX2,iX3,iX1)

        dU_d_dX1_COV(iNodeX,3,iX1,iX2,iX3)  &
          = dU_d_dX1_Temp(iNodeX,4,iX2,iX3,iX1)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO mu = 0,3
        ...
        dU_d_dX1_COV(iNodeX,0,iX1,iX2,iX3)  &
        = dU_d_dX1_COV(iNodeX,0,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,1,0,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX2,iX3,iX1)

        dU_d_dX1_COV(iNodeX,1,iX1,iX2,iX3)  &
        = dU_d_dX1_COV(iNodeX,1,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,1,1,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX2,iX3,iX1)
    
        dU_d_dX1_COV(iNodeX,2,iX1,iX2,iX3)  &
        = dU_d_dX1_COV(iNodeX,2,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,1,2,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX2,iX3,iX1)
    
        dU_d_dX1_COV(iNodeX,3,iX1,iX2,iX3)  &
        = dU_d_dX1_COV(iNodeX,3,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,1,3,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX2,iX3,iX1)
  ...
  SUBROUTINE ComputeWeakDerivatives_X2 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, uCF, Gamma_udd, dU_d_dX2, dU_d_dX2_COV, Verbose_Option  )
    ...
    INTEGER  :: iNodeX
    INTEGER  :: iX1, iX2, iX3, iGF, iCF, mu
    ...
    REAL(DP) :: &
      U_d_X2(nDOFX_X2,4,iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3), &
             iX_B0(2):iX_E0(2)+1), &
      U_d_K(nDOFX,4,iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3), &
            iX_B0(2):iX_E0(2)), &
      U_d(nDOFX,4,iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3), &
            iX_B0(2):iX_E0(2))
    REAL(DP) :: &
      dU_d_dX2_Temp &
         (1:nDOFX,4, &
          iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3),iX_B0(2):iX_E0(2)) 
    LOGICAL :: Verbose
    ...
    nK    = iX_E0 - iX_B0 + 1 ! Number of Elements per Phase Space Dimension
    nK_X2 = nK + [0,1,0]    ! Number of X2 Faces per Phase Space Dimension
    nX    = PRODUCT( nK   (1:3) ) ! Number of Elements in Position Space
    nX_X2 = PRODUCT( nK_X2(1:3) ) ! Number of X2 Faces in Position Space
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        uCF_K(iNodeX,iCF,iX1,iX3,iX2) = uCF(iNodeX,iX1,iX2,iX3,iCF)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX_X2
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_L(iNodeX,iCF_D ,iX1,iX3,iX2), &
                 uCF_L(iNodeX,iCF_S1,iX1,iX3,iX2), &
                 uCF_L(iNodeX,iCF_S2,iX1,iX3,iX2), &
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_R(iNodeX,iCF_D ,iX1,iX3,iX2), &
                 uCF_R(iNodeX,iCF_S1,iX1,iX3,iX2), &
                 uCF_R(iNodeX,iCF_S2,iX1,iX3,iX2), &
        ...
        W_X2 = WeightsX_X2(iNodeX)  / SQRT(1.0_DP - Vsq_X2) 

        A_X2 = GX_F(iNodeX,iGF_Alpha,iX1,iX3,iX2)

        B_u_X2(1) = GX_F(iNodeX,iGF_Beta_1,iX1,iX3,iX2)
        B_u_X2(2) = GX_F(iNodeX,iGF_Beta_2,iX1,iX3,iX2)
        B_u_X2(3) = GX_F(iNodeX,iGF_Beta_3,iX1,iX3,iX2)

        B_d_X2(1) = GX_F(iNodeX,iGF_Gm_dd_11,iX1,iX3,iX2) * B_u_X2(1)
        B_d_X2(2) = GX_F(iNodeX,iGF_Gm_dd_22,iX1,iX3,iX2) * B_u_X2(2)
        B_d_X2(3) = GX_F(iNodeX,iGF_Gm_dd_33,iX1,iX3,iX2) * B_u_X2(3)




        U_d_X2(iNodeX,1,iX1,iX3,iX2) = W_X2 * ( - A_X2 + B_d_X2(1) * V_u_X2(1) &
                                     + B_d_X2(2) * V_u_X2(2) + B_d_X2(3) * V_u_X2(3) )
        
        U_d_X2(iNodeX,2,iX1,iX3,iX2) = W_X2 * V_d_X2(1) 

        U_d_X2(iNodeX,3,iX1,iX3,iX2) = W_X2 * V_d_X2(2) 

        U_d_X2(iNodeX,4,iX1,iX3,iX2) = W_X2 * V_d_X2(3)
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X2, - One, LX_X2_Dn, nDOFX_X2, &
             U_d_X2(1,1,iX_B0(1),iX_B0(3),iX_B0(2)  ), nDOFX_X2, Zero, &
             dU_d_dX2_Temp, nDOFX )


    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X2, + One, LX_X2_Up, nDOFX_X2, &
             U_d_X2(1,1,iX_B0(1),iX_B0(3),iX_B0(2)+1), nDOFX_X2, One,  &
             dU_d_dX2_Temp, nDOFX )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        A_K = GX_K(iNodeX, iGF_Alpha, iX1,iX3,iX2)

        B_u_K(1) =  GX_K(iNodeX, iGF_Beta_1,iX1,iX3,iX2)
        B_u_K(2) =  GX_K(iNodeX, iGF_Beta_2,iX1,iX3,iX2)
        B_u_K(3) =  GX_K(iNodeX, iGF_Beta_3,iX1,iX3,iX2)

        B_d_K(1) =  GX_K(iNodeX, iGF_Gm_dd_11,iX1,iX3,iX2) * B_u_K(1)
        B_d_K(2) =  GX_K(iNodeX, iGF_Gm_dd_22,iX1,iX3,iX2) * B_u_K(2)
        B_d_K(3) =  GX_K(iNodeX, iGF_Gm_dd_33,iX1,iX3,iX2) * B_u_K(3)
        ...
        U_d(iNodeX,1,iX1,iX3,iX2) = W_K * ( -A_K + B_d_K(1) * V_u_K(1) &
                                              +    B_d_K(2) * V_u_K(2) &
                                              +    B_d_K(3) * V_u_K(3)  )

        U_d(iNodeX,2,iX1,iX3,iX2) = W_K * V_d_K(1) 

        U_d(iNodeX,3,iX1,iX3,iX2) = W_K * V_d_K(2) 

        U_d(iNodeX,4,iX1,iX3,iX2) = W_K * V_d_K(3)


        U_d_K(iNodeX,1,iX1,iX3,iX2) = WeightsX_q(iNodeX) * U_d(iNodeX,1,iX1,iX3,iX2)
        U_d_K(iNodeX,2,iX1,iX3,iX2) = WeightsX_q(iNodeX) * U_d(iNodeX,2,iX1,iX3,iX2)
        U_d_K(iNodeX,3,iX1,iX3,iX2) = WeightsX_q(iNodeX) * U_d(iNodeX,3,iX1,iX3,iX2)
        U_d_K(iNodeX,4,iX1,iX3,iX2) = WeightsX_q(iNodeX) * U_d(iNodeX,4,iX1,iX3,iX2)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dU_d_dX2_Temp(iNodeX,1,iX1,iX3,iX2) &
         = dU_d_dX2_Temp(iNodeX,1,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )


        dU_d_dX2_Temp(iNodeX,2,iX1,iX3,iX2) &
         = dU_d_dX2_Temp(iNodeX,2,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dU_d_dX2_Temp(iNodeX,3,iX1,iX3,iX2) &
         = dU_d_dX2_Temp(iNodeX,3,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dU_d_dX2_Temp(iNodeX,4,iX1,iX3,iX2) &
         = dU_d_dX2_Temp(iNodeX,4,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dU_d_dX2(iNodeX,0,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,1,iX1,iX3,iX2)

        dU_d_dX2(iNodeX,1,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,2,iX1,iX3,iX2)

        dU_d_dX2(iNodeX,2,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,3,iX1,iX3,iX2)

        dU_d_dX2(iNodeX,3,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,4,iX1,iX3,iX2)




        dU_d_dX2_COV(iNodeX,0,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,1,iX1,iX3,iX2)

        dU_d_dX2_COV(iNodeX,1,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,2,iX1,iX3,iX2)

        dU_d_dX2_COV(iNodeX,2,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,3,iX1,iX3,iX2)

        dU_d_dX2_COV(iNodeX,3,iX1,iX2,iX3)  &
          = dU_d_dX2_Temp(iNodeX,4,iX1,iX3,iX2)
      END DO
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO mu = 0,3
        ...
        dU_d_dX2_COV(iNodeX,0,iX1,iX2,iX3)  &
        = dU_d_dX2_COV(iNodeX,0,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,2,0,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX3,iX2)

        dU_d_dX2_COV(iNodeX,1,iX1,iX2,iX3)  &
        = dU_d_dX2_COV(iNodeX,1,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,2,1,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX3,iX2)
    
        dU_d_dX2_COV(iNodeX,2,iX1,iX2,iX3)  &
        = dU_d_dX2_COV(iNodeX,2,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,2,2,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX3,iX2)
    
        dU_d_dX2_COV(iNodeX,3,iX1,iX2,iX3)  &
        = dU_d_dX2_COV(iNodeX,3,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,2,3,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX3,iX2)
  ...
  SUBROUTINE ComputeWeakDerivatives_X3 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, uCF, Gamma_udd, dU_d_dX3, dU_d_dX3_COV, Verbose_Option  )
    ...
    REAL(DP) :: &
      U_d_X3(nDOFX_X3,4,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
             iX_B0(3):iX_E0(3)+1), &
      U_d_K(nDOFX,4,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
            iX_B0(3):iX_E0(3)), &
      U_d(nDOFX,4,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
            iX_B0(3):iX_E0(3))
    REAL(DP) :: &
    ...
    nK    = iX_E0 - iX_B0 + 1 ! Number of Elements per Phase Space Dimension
    nK_X3 = nK + [0,0,1]    ! Number of X2 Faces per Phase Space Dimension
    nX    = PRODUCT( nK   (1:3) ) ! Number of Elements in Position Space
    nX_X3 = PRODUCT( nK_X3(1:3) ) ! Number of X2 Faces in Position Space
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        uCF_K(iNodeX,iCF,iX1,iX2,iX3) = uCF(iNodeX,iX1,iX2,iX3,iCF)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX_X3
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_L(iNodeX,iCF_D ,iX1,iX2,iX3), &
                 uCF_L(iNodeX,iCF_S1,iX1,iX2,iX3), &
                 uCF_L(iNodeX,iCF_S2,iX1,iX2,iX3), &
        ...
        CALL ComputePrimitive_Euler_Relativistic &
               ( uCF_R(iNodeX,iCF_D ,iX1,iX2,iX3), &
                 uCF_R(iNodeX,iCF_S1,iX1,iX2,iX3), &
                 uCF_R(iNodeX,iCF_S2,iX1,iX2,iX3), &
        ...
        A_X3 = GX_F(iNodeX,iGF_Alpha,iX1,iX2,iX3)

        B_u_X3(1) = GX_F(iNodeX,iGF_Beta_1,iX1,iX2,iX3)
        B_u_X3(2) = GX_F(iNodeX,iGF_Beta_2,iX1,iX2,iX3)
        B_u_X3(3) = GX_F(iNodeX,iGF_Beta_3,iX1,iX2,iX3)

        B_d_X3(1) = GX_F(iNodeX,iGF_Gm_dd_11,iX1,iX2,iX3) * B_u_X3(1)
        B_d_X3(2) = GX_F(iNodeX,iGF_Gm_dd_22,iX1,iX2,iX3) * B_u_X3(2)
        B_d_X3(3) = GX_F(iNodeX,iGF_Gm_dd_33,iX1,iX2,iX3) * B_u_X3(3)





        U_d_X3(iNodeX,1,iX1,iX2,iX3) = W_X3 * ( - A_X3 + B_d_X3(1) * V_u_X3(1) &
                                     + B_d_X3(2) * V_u_X3(2) + B_d_X3(3) * V_u_X3(3) )
        
        U_d_X3(iNodeX,2,iX1,iX2,iX3) = W_X3 * V_d_X3(1) 

        U_d_X3(iNodeX,3,iX1,iX2,iX3) = W_X3 * V_d_X3(2) 

        U_d_X3(iNodeX,4,iX1,iX2,iX3) = W_X3 * V_d_X3(3)
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X3, - One, LX_X3_Dn, nDOFX_X3, &
             U_d_X3(1,1,iX_B0(1),iX_B0(2),iX_B0(3)  ), nDOFX_X3, Zero, &
             dU_d_dX3_Temp, nDOFX )


    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 4*nX, nDOFX_X3, + One, LX_X3_Up, nDOFX_X3, &
             U_d_X3(1,1,iX_B0(1),iX_B0(2),iX_B0(3)+1), nDOFX_X3, One,  &
             dU_d_dX3_Temp, nDOFX )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        A_K = GX_K(iNodeX,iGF_Alpha,iX1,iX2,iX3)

        B_u_K(1) =  GX_K(iNodeX,iGF_Beta_1,iX1,iX2,iX3)
        B_u_K(2) =  GX_K(iNodeX,iGF_Beta_2,iX1,iX2,iX3)
        B_u_K(3) =  GX_K(iNodeX,iGF_Beta_3,iX1,iX2,iX3)

        B_d_K(1) =  GX_K(iNodeX,iGF_Gm_dd_11,iX1,iX2,iX3) * B_u_K(1)
        B_d_K(2) =  GX_K(iNodeX,iGF_Gm_dd_22,iX1,iX2,iX3) * B_u_K(2)
        B_d_K(3) =  GX_K(iNodeX,iGF_Gm_dd_33,iX1,iX2,iX3) * B_u_K(3)
        ...
        U_d_K(iNodeX,1,iX1,iX2,iX3) = WeightsX_q(iNodeX) * U_d(iNodeX,1,iX1,iX2,iX3)
        U_d_K(iNodeX,2,iX1,iX2,iX3) = WeightsX_q(iNodeX) * U_d(iNodeX,2,iX1,iX2,iX3)
        U_d_K(iNodeX,3,iX1,iX2,iX3) = WeightsX_q(iNodeX) * U_d(iNodeX,3,iX1,iX2,iX3)
        U_d_K(iNodeX,4,iX1,iX2,iX3) = WeightsX_q(iNodeX) * U_d(iNodeX,4,iX1,iX2,iX3)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dU_d_dX3_Temp(iNodeX,1,iX1,iX2,iX3) &
         = dU_d_dX3_Temp(iNodeX,1,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dU_d_dX3_Temp(iNodeX,2,iX1,iX2,iX3) &
         = dU_d_dX3_Temp(iNodeX,2,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )

        dU_d_dX3_Temp(iNodeX,3,iX1,iX2,iX3) &
         = dU_d_dX3_Temp(iNodeX,3,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )

        dU_d_dX3_Temp(iNodeX,4,iX1,iX2,iX3) &
         = dU_d_dX3_Temp(iNodeX,4,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dU_d_dX3_COV(iNodeX,0,iX1,iX2,iX3)  &
          = dU_d_dX3_Temp(iNodeX,1,iX1,iX2,iX3)

        dU_d_dX3_COV(iNodeX,1,iX1,iX2,iX3)  &
          = dU_d_dX3_Temp(iNodeX,2,iX1,iX2,iX3)

        dU_d_dX3_COV(iNodeX,2,iX1,iX2,iX3)  &
          = dU_d_dX3_Temp(iNodeX,3,iX1,iX2,iX3)

        dU_d_dX3_COV(iNodeX,3,iX1,iX2,iX3)  &
          = dU_d_dX3_Temp(iNodeX,4,iX1,iX2,iX3)
      END DO
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO mu = 0,3
        ...
        dU_d_dX3_COV(iNodeX,0,iX1,iX2,iX3)  &
        = dU_d_dX3_COV(iNodeX,0,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,3,0,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)

        dU_d_dX3_COV(iNodeX,1,iX1,iX2,iX3)  &
        = dU_d_dX3_COV(iNodeX,1,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,3,1,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)
    
        dU_d_dX3_COV(iNodeX,2,iX1,iX2,iX3)  &
        = dU_d_dX3_COV(iNodeX,2,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,3,2,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)
    
        dU_d_dX3_COV(iNodeX,3,iX1,iX2,iX3)  &
        = dU_d_dX3_COV(iNodeX,3,iX1,iX2,iX3) &
        - Gamma_udd(iNodeX,mu,3,3,iX1,iX2,iX3) * U_d(iNodeX,mu+1,iX1,iX2,iX3)
  ...
  SUBROUTINE ComputeGeometryDerivatives_X0 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, dG_dd_dX0, Verbose_Option  )
  ...
  SUBROUTINE ComputeGeometryDerivatives_X1 &
   ( iX_B0, iX_E0, iX_B1, iX_E1, GX, dG_dd_dX1, Verbose_Option  )
    ...
    REAL(DP) :: &
      ...
      H_munu_K(nDOFX   ,7,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
           iX_B0(1):iX_E0(1)), &
      H_munu_F(nDOFX_X1,7,iX_B0(2):iX_E0(2),iX_B0(3):iX_E0(3), &
           iX_B0(1):iX_E0(1)+1)
    REAL(DP) :: & 
      dG_dd_dX1_Temp &
         (1:nDOFX,7, &
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        G_munu_K(iNodeX,1,iX2,iX3,iX1) = -A_K**2 + B_d_K(1) * B_u_K(1) + B_d_K(2) * B_u_K(2) + B_d_K(3) * B_u_K(3)
       
        G_munu_K(iNodeX,2,iX2,iX3,iX1) = B_d_K(1)


        G_munu_K(iNodeX,3,iX2,iX3,iX1) = B_d_K(2) 
        
        G_munu_K(iNodeX,4,iX2,iX3,iX1) = B_d_K(3) 
        
        G_munu_K(iNodeX,5,iX2,iX3,iX1) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11)


        G_munu_K(iNodeX,6,iX2,iX3,iX1) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22)
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX_X1
        ...
        H_munu_F(iNodeX,2,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,2,iX2,iX3,iX1)
        
        H_munu_F(iNodeX,3,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,3,iX2,iX3,iX1)
        
        H_munu_F(iNodeX,4,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,4,iX2,iX3,iX1)


        H_munu_F(iNodeX,5,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,5,iX2,iX3,iX1)


        H_munu_F(iNodeX,6,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,6,iX2,iX3,iX1)


        H_munu_F(iNodeX,7,iX2,iX3,iX1) = WeightsX_X1(iNodeX) * G_munu_F(iNodeX,7,iX2,iX3,iX1)
     END DO
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X1, - One, LX_X1_Dn, nDOFX_X1, &
             H_munu_F(1,1,iX_B0(2),iX_B0(3),iX_B0(1)  ), nDOFX_X1, Zero, &
             dG_dd_dX1_Temp, nDOFX )


    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X1, + One, LX_X1_Up, nDOFX_X1, &
             H_munu_F(1,1,iX_B0(2),iX_B0(3),iX_B0(1)+1), nDOFX_X1, One,  &
             dG_dd_dX1_Temp, nDOFX )
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        H_munu_K(iNodeX,1,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,1,iX2,iX3,iX1)


        H_munu_K(iNodeX,2,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,2,iX2,iX3,iX1)


        H_munu_K(iNodeX,3,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,3,iX2,iX3,iX1)


        H_munu_K(iNodeX,4,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,4,iX2,iX3,iX1)


        H_munu_K(iNodeX,5,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,5,iX2,iX3,iX1)


        H_munu_K(iNodeX,6,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,6,iX2,iX3,iX1)


        H_munu_K(iNodeX,7,iX2,iX3,iX1) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,7,iX2,iX3,iX1)
    ...
    DO iX2 = iX_B0(2), iX_E0(2)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX1_Temp(iNodeX,1,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,1,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )


        dG_dd_dX1_Temp(iNodeX,2,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,2,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )


        dG_dd_dX1_Temp(iNodeX,3,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,3,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )


        dG_dd_dX1_Temp(iNodeX,4,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,4,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )
        ...
        dG_dd_dX1_Temp(iNodeX,5,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,5,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )


        dG_dd_dX1_Temp(iNodeX,6,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,6,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )


        dG_dd_dX1_Temp(iNodeX,7,iX2,iX3,iX1) &
         = dG_dd_dX1_Temp(iNodeX,7,iX2,iX3,iX1) &
             / ( WeightsX_q(iNodeX) * dZ2(iX1) )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX1(iNodeX,0,0,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,1,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,0,1,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,2,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,0,2,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,3,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,0,3,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,4,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,1,0,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,2,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,2,0,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,3,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,3,0,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,4,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,1,1,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,5,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,2,2,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,6,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,3,3,iX1,iX2,iX3) = dG_dd_dX1_Temp(iNodeX,7,iX2,iX3,iX1) 


        dG_dd_dX1(iNodeX,1,2,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX1(iNodeX,2,1,iX1,iX2,iX3) = 0.0_DP 


        dG_dd_dX1(iNodeX,1,3,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX1(iNodeX,3,1,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX1(iNodeX,2,3,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX1(iNodeX,3,2,iX1,iX2,iX3) = 0.0_DP
  ...
  SUBROUTINE ComputeGeometryDerivatives_X2 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, dG_dd_dX2, Verbose_Option  )
    ...
    REAL(DP) :: &
      ...
      H_munu_K(nDOFX   ,7,iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3), &
           iX_B0(2):iX_E0(2)), &
      H_munu_F(nDOFX_X2,7,iX_B0(1):iX_E0(1),iX_B0(3):iX_E0(3), &
           iX_B0(2):iX_E0(2)+1)
    REAL(DP) ::  B_u_K(3), B_d_K(3), A_K
    REAL(DP) :: & 
      dG_dd_dX2_Temp &
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        G_munu_K(iNodeX,1,iX1,iX3,iX2) = -A_K**2 + B_d_K(1) * B_u_K(1) + B_d_K(2) * B_u_K(2) + B_d_K(3) * B_u_K(3)

        G_munu_K(iNodeX,2,iX1,iX3,iX2) = B_d_K(1)

        G_munu_K(iNodeX,3,iX1,iX3,iX2) = B_d_K(2) 
        
        G_munu_K(iNodeX,4,iX1,iX3,iX2) = B_d_K(3) 
        
        G_munu_K(iNodeX,5,iX1,iX3,iX2) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11)

        G_munu_K(iNodeX,6,iX1,iX3,iX2) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX_X2
        ...
        H_munu_F(iNodeX,2,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,2,iX1,iX3,iX2)
        
        H_munu_F(iNodeX,3,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,3,iX1,iX3,iX2)
        
        H_munu_F(iNodeX,4,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,4,iX1,iX3,iX2)

        H_munu_F(iNodeX,5,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,5,iX1,iX3,iX2)

        H_munu_F(iNodeX,6,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,6,iX1,iX3,iX2)

        H_munu_F(iNodeX,7,iX1,iX3,iX2) = WeightsX_X2(iNodeX) * G_munu_F(iNodeX,7,iX1,iX3,iX2)
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X2, - One, LX_X2_Dn, nDOFX_X2, &
             H_munu_F(1,1,iX_B0(1),iX_B0(3),iX_B0(2)  ), nDOFX_X2, Zero, &
             dG_dd_dX2_Temp, nDOFX )

    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X2, + One, LX_X2_Up, nDOFX_X2, &
             H_munu_F(1,1,iX_B0(1),iX_B0(3),iX_B0(2)+1), nDOFX_X2, One,  &
             dG_dd_dX2_Temp, nDOFX )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        H_munu_K(iNodeX,1,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,1,iX1,iX3,iX2)

        H_munu_K(iNodeX,2,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,2,iX1,iX3,iX2)

        H_munu_K(iNodeX,3,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,3,iX1,iX3,iX2)

        H_munu_K(iNodeX,4,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,4,iX1,iX3,iX2)

        H_munu_K(iNodeX,5,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,5,iX1,iX3,iX2)

        H_munu_K(iNodeX,6,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,6,iX1,iX3,iX2)

        H_munu_K(iNodeX,7,iX1,iX3,iX2) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,7,iX1,iX3,iX2)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX2_Temp(iNodeX,1,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,1,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dG_dd_dX2_Temp(iNodeX,2,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,2,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dG_dd_dX2_Temp(iNodeX,3,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,3,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dG_dd_dX2_Temp(iNodeX,4,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,4,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )


        dG_dd_dX2_Temp(iNodeX,5,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,5,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dG_dd_dX2_Temp(iNodeX,6,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,6,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )

        dG_dd_dX2_Temp(iNodeX,7,iX1,iX3,iX2) &
         = dG_dd_dX2_Temp(iNodeX,7,iX1,iX3,iX2) &
             / ( WeightsX_q(iNodeX) * dZ3(iX2) )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX2(iNodeX,0,0,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,1,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,0,1,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,2,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,0,2,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,3,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,0,3,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,4,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,1,0,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,2,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,2,0,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,3,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,3,0,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,4,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,1,1,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,5,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,2,2,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,6,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,3,3,iX1,iX2,iX3) = dG_dd_dX2_Temp(iNodeX,7,iX1,iX3,iX2) 

        dG_dd_dX2(iNodeX,1,2,iX1,iX2,iX3) = 0.0_DP

        dG_dd_dX2(iNodeX,2,1,iX1,iX2,iX3) = 0.0_DP 

        dG_dd_dX2(iNodeX,1,3,iX1,iX2,iX3) = 0.0_DP

        dG_dd_dX2(iNodeX,3,1,iX1,iX2,iX3) = 0.0_DP

        dG_dd_dX2(iNodeX,2,3,iX1,iX2,iX3) = 0.0_DP

        dG_dd_dX2(iNodeX,3,2,iX1,iX2,iX3) = 0.0_DP
  ...
  SUBROUTINE ComputeGeometryDerivatives_X3 &
    ( iX_B0, iX_E0, iX_B1, iX_E1, GX, dG_dd_dX3, Verbose_Option  )
    ...
    REAL(DP) :: &
      ...
      H_munu_K(nDOFX   ,7,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
           iX_B0(3):iX_E0(3)), &
      H_munu_F(nDOFX_X3,7,iX_B0(1):iX_E0(1),iX_B0(2):iX_E0(2), &
           iX_B0(3):iX_E0(3)+1)
    REAL(DP) :: & 
      dG_dd_dX3_Temp &
         (1:nDOFX,7, &
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        G_munu_K(iNodeX,1,iX1,iX2,iX3) = -A_K**2 + B_d_K(1) * B_u_K(1) + B_d_K(2) * B_u_K(2) + B_d_K(3) * B_u_K(3)


        G_munu_K(iNodeX,2,iX1,iX2,iX3) = B_d_K(1)


        G_munu_K(iNodeX,3,iX1,iX2,iX3) = B_d_K(2) 
        
        G_munu_K(iNodeX,4,iX1,iX2,iX3) = B_d_K(3) 
        
        G_munu_K(iNodeX,5,iX1,iX2,iX3) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11)


        G_munu_K(iNodeX,6,iX1,iX2,iX3) = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX_X3
        ...
        H_munu_F(iNodeX,1,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,1,iX1,iX2,iX3)
        
        H_munu_F(iNodeX,2,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,2,iX1,iX2,iX3)
        
        H_munu_F(iNodeX,3,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,3,iX1,iX2,iX3)
        
        H_munu_F(iNodeX,4,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,4,iX1,iX2,iX3)


        H_munu_F(iNodeX,5,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,5,iX1,iX2,iX3)


        H_munu_F(iNodeX,6,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,6,iX1,iX2,iX3)


        H_munu_F(iNodeX,7,iX1,iX2,iX3) = WeightsX_X3(iNodeX) * G_munu_F(iNodeX,7,iX1,iX2,iX3)
    ...
    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X3, - One, LX_X3_Dn, nDOFX_X3, &
             H_munu_F(1,1,iX_B0(1),iX_B0(2),iX_B0(3)  ), nDOFX_X3, Zero, &
             dG_dd_dX3_Temp, nDOFX )


    CALL MatrixMatrixMultiply &
           ( 'T', 'N', nDOFX, 7*nX, nDOFX_X3, + One, LX_X3_Up, nDOFX_X3, &
             H_munu_F(1,1,iX_B0(1),iX_B0(2),iX_B0(3)+1), nDOFX_X3, One,  &
             dG_dd_dX3_Temp, nDOFX )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        H_munu_K(iNodeX,1,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,1,iX1,iX2,iX3)


        H_munu_K(iNodeX,2,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,2,iX1,iX2,iX3)


        H_munu_K(iNodeX,3,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,3,iX1,iX2,iX3)


        H_munu_K(iNodeX,4,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,4,iX1,iX2,iX3)


        H_munu_K(iNodeX,5,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,5,iX1,iX2,iX3)


        H_munu_K(iNodeX,6,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,6,iX1,iX2,iX3)


        H_munu_K(iNodeX,7,iX1,iX2,iX3) = WeightsX_q(iNodeX) * G_munu_K(iNodeX,7,iX1,iX2,iX3)
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX3_Temp(iNodeX,1,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,1,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dG_dd_dX3_Temp(iNodeX,2,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,2,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dG_dd_dX3_Temp(iNodeX,3,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,3,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dG_dd_dX3_Temp(iNodeX,4,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,4,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )
        ...
        dG_dd_dX3_Temp(iNodeX,5,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,5,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dG_dd_dX3_Temp(iNodeX,6,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,6,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )


        dG_dd_dX3_Temp(iNodeX,7,iX1,iX2,iX3) &
         = dG_dd_dX3_Temp(iNodeX,7,iX1,iX2,iX3) &
             / ( WeightsX_q(iNodeX) * dZ4(iX3) )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_dd_dX3(iNodeX,0,0,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,1,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,0,1,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,2,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,0,2,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,3,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,0,3,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,4,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,1,0,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,2,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,2,0,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,3,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,3,0,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,4,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,1,1,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,5,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,2,2,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,6,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,3,3,iX1,iX2,iX3) = dG_dd_dX3_Temp(iNodeX,7,iX1,iX2,iX3) 


        dG_dd_dX3(iNodeX,1,2,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX3(iNodeX,2,3,iX1,iX2,iX3) = 0.0_DP 


        dG_dd_dX3(iNodeX,2,1,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX3(iNodeX,3,2,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX3(iNodeX,1,3,iX1,iX2,iX3) = 0.0_DP


        dG_dd_dX3(iNodeX,3,1,iX1,iX2,iX3) = 0.0_DP
  ...
  SUBROUTINE ComputeChristoffel( iX_B0, iX_E0, iX_B1, iX_E1, GX, &
                                 dG_dd_dX0, dG_dd_dX1, dG_dd_dX2, dG_dd_dX3, Gamma_udd )
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        dG_munu_dXrho(iNodeX,0,:,:,iX1,iX2,iX3) = dG_dd_dX0(iNodeX,:,:,iX1,iX2,iX3)
        dG_munu_dXrho(iNodeX,1,:,:,iX1,iX2,iX3) = dG_dd_dX1(iNodeX,:,:,iX1,iX2,iX3)
        dG_munu_dXrho(iNodeX,2,:,:,iX1,iX2,iX3) = dG_dd_dX2(iNodeX,:,:,iX1,iX2,iX3)
        dG_munu_dXrho(iNodeX,3,:,:,iX1,iX2,iX3) = dG_dd_dX3(iNodeX,:,:,iX1,iX2,iX3)
        ...
        G_dd_11 = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_11)
        G_dd_22 = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_22)
        G_dd_33 = GX(iNodeX,iX1,iX2,iX3,iGF_Gm_dd_33)
 


        A = GX(iNodeX,iX1,iX2,iX3,iGF_Alpha)
        B(1) = GX(iNodeX,iX1,iX2,iX3,iGF_Beta_1)
        B(2) = GX(iNodeX,iX1,iX2,iX3,iGF_Beta_2)
        B(3) = GX(iNodeX,iX1,iX2,iX3,iGF_Beta_3)


        G_uu_munu(iNodeX,:,:,iX1,iX2,iX3) = 0.0_DP
          
        G_uu_munu(iNodeX,0,0,iX1,iX2,iX3) = -1.0_DP / A**2
        G_uu_munu(iNodeX,1,0,iX1,iX2,iX3) = B(1) / A**2
        G_uu_munu(iNodeX,2,0,iX1,iX2,iX3) = B(2) / A**2
        G_uu_munu(iNodeX,3,0,iX1,iX2,iX3) = B(3) / A**2
    ...
    DO iX1 = iX_B0(1), iX_E0(1)
      ...
      DO iNodeX = 1, nDOFX
        ...
        Gamma_udd(iNodeX,rho,mu,nu,iX1,iX2,iX3) = Gamma_udd(iNodeX,rho,mu,nu,iX1,iX2,iX3) &
                                                + 0.5_DP * G_uu_munu(iNodeX,sig,rho,iX1,iX2,iX3) &
                                                * ( dG_munu_dXrho(iNodeX,nu,mu,sig,iX1,iX2,iX3) &
                                                + dG_munu_dXrho(iNodeX,mu,nu,sig,iX1,iX2,iX3) &
  ...
  SUBROUTINE InitializeIncrement_ObserverCorrections &
    ...
    G_Alpha_K (1:nNodesX_K) => uGF_K(:,:,:,iZ_B0(4):iZ_E0(4),iGF_Alpha   )
    G_Beta_1_K(1:nNodesX_K) => uGF_K(:,:,:,iZ_B0(4):iZ_E0(4),iGF_Beta_1  )
    G_Beta_2_K(1:nNodesX_K) => uGF_K(:,:,:,iZ_B0(4):iZ_E0(4),iGF_Beta_2  )
    G_Beta_3_K(1:nNodesX_K) => uGF_K(:,:,:,iZ_B0(4):iZ_E0(4),iGF_Beta_3  )

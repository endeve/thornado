MODULE TaggingModule
  ...
  PUBLIC :: TagElements_StandingAccretionShock_Relativistic
...
!           .AND. ( MeshX(3) % Center(iX3) .GT. TagCriteria_this ) )THEN
  ...
  SUBROUTINE TagElements_StandingAccretionShock_Relativistic &
    ( iLevel, iX_B0, iX_E0, iLo, iHi, uCF, TagCriteria, &
      SetTag, ClearTag, TagLo, TagHi, Tag )
  ...
  END SUBROUTINE TagElements_StandingAccretionShock_Relativistic

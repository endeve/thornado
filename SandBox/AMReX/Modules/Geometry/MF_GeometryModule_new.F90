MODULE MF_GeometryModule
  ...
  INTERFACE UpdateSpatialMetric_MF
    MODULE PROCEDURE UpdateSpatialMetric_MF_SingleLevel_Scalar
    MODULE PROCEDURE UpdateSpatialMetric_MF_SingleLevel_Vector
...
CONTAINS
  ...
  SUBROUTINE ApplyBoundaryConditions_Geometry_MF_AllLevels( MF_uGF )
    ...
    IF( .NOT. amrex_is_all_periodic() )THEN
      ...
      CALL ApplyBoundaryConditions_Geometry_MF_X1_AllLevels( MF_uGF )
  ...
  SUBROUTINE ApplyBoundaryConditions_Geometry_MF_SingleLevel( iLevel, MF_uGF )
    ...
    IF( .NOT. amrex_is_all_periodic() )THEN
      ...
      CALL ApplyBoundaryConditions_Geometry_MF_X1_SingleLevel( iLevel, MF_uGF )
  ...
  SUBROUTINE UpdateSpatialMetric_MF_AllLevels &
    ( MF_uGF, swX_Option, CoveredElementsOnly_Option )
    ...
    DO iLevel = 0, nLevels-1
      ...
      CALL UpdateSpatialMetric_MF_SingleLevel_Vector &
             ( iLevel, MF_uGF, swX_Option = swXX, &
               CoveredElementsOnly_Option = CoveredElementsOnly )
  ...
  SUBROUTINE UpdateSpatialMetric_MF_SingleLevel_Scalar &
    ( iLevel, MF_uGF, swX_Option, CoveredElementsOnly_Option )
    ...
    INTEGER  :: iNX, iX1, iX2, iX3, iNX1, iNX2, swXX(3), iGF
    INTEGER  :: iX_B(3), iX_E(3)
    REAL(DP) :: X1, X2, Psi, h1, h2, h3, SqrtGm
...
!      FineMask => iMF_FineMask % DataPtr( MFI )
      ...
      DO iNX = 1      , nDOFX
        ...
        SqrtGm = uGF(iX1,iX2,iX3,nDOFX*(iGF_SqrtGm-1)+iNX)

        IF( SqrtGm .GE. Zero ) CYCLE
        ...
        ! These are \sqrt{\gamma} * \psi and \sqrt{\gamma} * h1
        Psi = uGF(iX1,iX2,iX3,nDOFX*(iGF_Psi-1)+iNX)
        h1  = uGF(iX1,iX2,iX3,nDOFX*(iGF_h_1-1)+iNX)
...
!    CALL DestroyFineMask( iMF_FineMask )
  ...
  END SUBROUTINE UpdateSpatialMetric_MF_SingleLevel_Scalar


  SUBROUTINE UpdateSpatialMetric_MF_SingleLevel_Vector &
    ( iLevel, MF_uGF, swX_Option, CoveredElementsOnly_Option )
  ...
  END SUBROUTINE UpdateSpatialMetric_MF_SingleLevel_Vector


  SUBROUTINE ApplyBoundaryConditions_Geometry_MF_X1_SingleLevel &
    ( iLevel, MF_uGF )
  ...
  END SUBROUTINE ApplyBoundaryConditions_Geometry_MF_X1_SingleLevel


  SUBROUTINE ApplyBoundaryConditions_Geometry_MF_X1_AllLevels( MF_uGF )
    ...
    DO iLevel = 0, nLevels-1
      ...
      CALL ApplyBoundaryConditions_Geometry_MF_X1_SingleLevel &
             ( iLevel, MF_uGF(iLevel) )

    END DO

  END SUBROUTINE ApplyBoundaryConditions_Geometry_MF_X1_AllLevels

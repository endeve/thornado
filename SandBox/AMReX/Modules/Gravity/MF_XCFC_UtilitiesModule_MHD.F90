MODULE MF_XCFC_UtilitiesModule
  ...
  USE MHD_ErrorModule, ONLY: &
    DescribeError_MHD
  USE MHD_XCFC_UtilitiesModule, ONLY: &
    ComputeConformalFactorSourcesAndMg_XCFC_MHD, &
    ComputePressureTensorTrace_XCFC_MHD
...
CONTAINS
  ...
  SUBROUTINE MultiplyWithPsi6_MF_X_AllLevels &
    ( MF_uGF, MF_uCM, Power, OnlyLeafElements_Option, swX_Option )
    ...
    DO iLevel = 0, nLevels-1
      ...
      !$OMP PARALLEL &
      !$OMP PRIVATE( BX, MFI, G, U, uGF, uCM, uFM, &
      ...
      DO WHILE( MFI % next() )
        ...
        CALL amrex2thornado_X &
               ( nCM, iX_B1, iX_E1, LBOUND( uCM ), iX_B, iX_E, uCM, U )
  ...
  SUBROUTINE MultiplyWithPsi6_MF_X_SingleLevel &
    ( MF_uGF, MF_uCM, Power, swX_Option )
...
#if defined( THORNADO_OMP )
    !$OMP PARALLEL &
    !$OMP PRIVATE( BX, MFI, G, U, uGF, uCM, &
...
! #if defined( THORNADO_OMP )
!       !$OMP PARALLEL &
!       !$OMP PRIVATE( BX, MFI, G, F, S, uGF, uCM, uGS, uFM, &
!       !$OMP          iX_B0, iX_E0, iX_B1, iX_E1 )
! #endif
      ...
      DO WHILE( MFI % next() )
        ...
        CALL amrex2thornado_X &
               ( nCM, iX_B1, iX_E1, LBOUND( uCM ), iX_B1, iX_E1, uCM, F )

        CALL amrex2thornado_X &
               ( nGS, iX_B0, iX_E0, LBOUND( uGS ), iX_B0, iX_E0, uGS, GS )

        CALL ComputeConformalFactorSourcesAndMg_XCFC_MHD &
               ( iX_B0, iX_E0, iX_B1, iX_E1, G, F, GS, EvolveOnlyMagnetic, Mask_Option = uFM )
        ...
        CALL ComputeConformalFactorSourcesAndMg_XCFC_TwoMoment &
               ( iLevel, iX_B0, iX_E0, iX_B1, iX_E1, uGF, uCM, uCR, uGS )
...
! #if defined( THORNADO_OMP )
!       !$OMP PARALLEL &
!       !$OMP PRIVATE( BX, MFI, G, U, S, uGF, uCM, uGS, uFM, &
!       !$OMP          iX_B0, iX_E0, iX_B1, iX_E1 )
! #endif
      ...
      DO WHILE( MFI % next() )
        ...
        CALL ComputePressureTensorTrace_XCFC_MHD &
               ( iX_B0, iX_E0, iX_B1, iX_E1, G, U, GS, EvolveOnlyMagnetic, Mask_Option = uFM )
  ...
  SUBROUTINE ComputeConformalFactorSourcesAndMg_XCFC_TwoMoment &
    ...
    DO iNX = 1       , nDOFX
      ...
      DO iCM = 1, nCM
        ...
        uCM    (iX1,iX2,iX3,nDOFX*(iCM-1)+iNX) &
          = uCM(iX1,iX2,iX3,nDOFX*(iCM-1)+iNX) / Psi6
               ...
               ( iErr(iNX,iX1,iX2,iX3), &
                 ...
                 Real_Option &
                   = [ MeshX(1) % Center(iX1), &
                       ...
                       MeshX(2) % Width (iX2), &
                       MeshX(3) % Width (iX3), &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_D -1)+iNX) / Psi6, &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_S1-1)+iNX) / Psi6, &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_S2-1)+iNX) / Psi6, &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_S3-1)+iNX) / Psi6, &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_E -1)+iNX) / Psi6, &
                       uCM(iX1,iX2,iX3,nDOFX*(iCM_Ne-1)+iNX) / Psi6, &
                       uGF(iX1,iX2,iX3,nDOFX*(iGF_Gm_dd_11-1)+iNX), &
                       uGF(iX1,iX2,iX3,nDOFX*(iGF_Gm_dd_22-1)+iNX), &
                       uGF(iX1,iX2,iX3,nDOFX*(iGF_Gm_dd_33-1)+iNX) ], &
                 Char_Option = [ 'NA' ], &

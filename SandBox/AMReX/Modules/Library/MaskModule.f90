...
CONTAINS
  ...
  SUBROUTINE CreateFineMask( iLevel, iMF_FineMask, BA, DM )
    ...
    IF( nLevels .GT. 1 .AND. iLevel .LT. nLevels-1 )THEN
      ...
      DO WHILE( MFI % next() )
        ...
        DO iX2 = iX_B0(2), iX_E0(2)
          ...
          FineMask(iX_B1(1),iX2,iX3,1) = FineMask(iX_B0(1),iX2,iX3,1)
          FineMask(iX_E1(1),iX2,iX3,1) = FineMask(iX_E0(1),iX2,iX3,1)
        ...
        DO iX1 = iX_B0(1), iX_E0(1)
          ...
          FineMask(iX1,iX_B1(2),iX3,1) = FineMask(iX1,iX_B0(2),iX3,1)
          FineMask(iX1,iX_E1(2),iX3,1) = FineMask(iX1,iX_E0(2),iX3,1)
        ...
        DO iX1 = iX_B0(1), iX_E0(1)
          ...
          FineMask(iX1,iX2,iX_B1(3),1) = FineMask(iX1,iX2,iX_B0(3),1)
          FineMask(iX1,iX2,iX_E1(3),1) = FineMask(iX1,iX2,iX_E0(3),1)
  ...
  SUBROUTINE DestroyFineMask( iLevel, iMF_FineMask )

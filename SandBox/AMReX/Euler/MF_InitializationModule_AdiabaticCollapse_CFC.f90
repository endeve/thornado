MODULE MF_InitializationModule_AdiabaticCollapse_CFC
  ...
  PUBLIC :: MF_InitializeFields_AdiabaticCollapse_CFC


CONTAINS


  SUBROUTINE MF_InitializeFields_AdiabaticCollapse_CFC &
    ...
    DO iLevel = 0, nLevels-1
      ...
      DO iDimX = 1, 3
        ...
        CALL CreateMesh &
               ( MeshX(iDimX), nX(iDimX), nNodesX(iDimX), swX(iDimX), &
                 xL(iDimX), xR(iDimX) )
  ...
  END SUBROUTINE MF_InitializeFields_AdiabaticCollapse_CFC
...
END MODULE MF_InitializationModule_AdiabaticCollapse_CFC

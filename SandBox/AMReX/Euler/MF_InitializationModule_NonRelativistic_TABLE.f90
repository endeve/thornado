...
CONTAINS
  ...
  SUBROUTINE InitializeFields_Implosion_TABLE( MF_uGF, MF_uCF )
    ...
    REAL(AR)            :: uPF_K(nDOFX,nPF)
    REAL(AR)            :: uAF_K(nDOFX,nAF)
    REAL(AR), PARAMETER :: D_0  = 1.25d13 * ( Gram / Centimeter**3 )
    REAL(AR), PARAMETER :: P_0  = 1.0d32  * ( Erg / Centimeter**3 )
    REAL(AR), PARAMETER :: Ye_0 = 1.35d-1
    REAL(AR), PARAMETER :: D_1  = 1.0d14  * ( Gram / Centimeter**3 )
    REAL(AR), PARAMETER :: P_1  = 1.0d33  * ( Erg / Centimeter**3 )
    REAL(AR), PARAMETER :: Ye_1 = 1.5d-1
    TYPE(MeshType) :: MeshX(3)

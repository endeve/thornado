MODULE MF_InitializationModule_CoreCollapseSupernova_XCFC
  ...
  PUBLIC :: InitializeFields_Euler_CoreCollapseSupernova_XCFC_MF

CONTAINS


  SUBROUTINE InitializeFields_Euler_CoreCollapseSupernova_XCFC_MF &
  ...
  END SUBROUTINE InitializeFields_Euler_CoreCollapseSupernova_XCFC_MF
...
END MODULE MF_InitializationModule_CoreCollapseSupernova_XCFC

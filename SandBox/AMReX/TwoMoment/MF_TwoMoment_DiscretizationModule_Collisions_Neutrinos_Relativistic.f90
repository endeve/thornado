MODULE MF_TwoMoment_DiscretizationModule_Collisions_Neutrinos_Relativistic
  ...
  USE FluidFieldsModule,            ONLY: &
    nCF
  USE TwoMoment_DiscretizationModule_Collisions_Neutrinos_Relativistic, ONLY: &
...
CONTAINS
  ...
  SUBROUTINE MF_TwoMoment_ComputeIncrement_Implicit( GEOM, MF_uGF, MF_uCF, MF_duCF, &

...
CONTAINS
  ...
  SUBROUTINE Update_IMEX_PC2( dt, GE, GX, U_F, U_R )
    ...
    CALL AddFields_Radiation &
           ( iZ_B0-iZ_SW, iZ_E0+iZ_SW, One, Half * dt, U_R, dU_R )
    ...
    CALL AddFields_Radiation &
           ( iZ_B0-iZ_SW, iZ_E0+iZ_SW, One, dt, U_R, dU_R )
  ...
  SUBROUTINE AddFields_Radiation( iZ_B, iZ_E, alpha, beta, A, B )

MODULE ScalarWave_dgDiscretizationModule
 ...
 USE ScalarFieldsModule, ONLY: &
  ...
  PUBLIC :: ComputeIncrement_DG_Explicit


CONTAINS


  SUBROUTINE ComputeIncrement_DG_Explicit &
  ...
  END SUBROUTINE ComputeIncrement_DG_Explicit
  ...
  SUBROUTINE ComputeIncrement_Divergence_X1 &
    ...
    REAL(DP) :: P_K(nDOFX)
    REAL(DP) :: EigVals_L(nDOFX_X1,nSF), EigVals_R(nDOFX_X1,nSF)
    ...
    !$OMP&   uSF_P, uSF_K, uSF_L, uSF_R, P_K, &
    !$OMP&   P_L, P_R, Cs_L, Cs_R, Flux_X1_q, &

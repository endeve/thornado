PROGRAM ApplicationDriverComponents
...
CONTAINS
  ...
  SUBROUTINE InitializeDriver
    ...
    CHARACTER(LEN=256) :: EOSTableName

    EOSTableName = "../../../../weaklib-tables-ornl/wl-EOS-SFHo-15-25-50.h5"
    EOSTableName = "../../../../weaklib_tables/FullEOS.h5"
...
END PROGRAM ApplicationDriverComponents
